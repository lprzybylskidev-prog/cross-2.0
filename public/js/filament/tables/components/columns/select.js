                ...
                if (((W = [...W, { placement: o, overflows: _ }]), !_.every((H) => H <= 0))) {
                    ...
                    if (
                        ...
                        (!(d === 'alignment' ? y !== ht(tt) : !1) ||
                            W.every((B) => (ht(B.placement) === y ? B.overflows[0] > 0 : !0)))
                    )
...
function lt(n, t, e, i) {
    if (n) {
        ...
        do {
            if (
                (t != null && (t[0] === '>' ? n.parentNode === e && ve(n, t) : ve(n, t))) ||
                (i && n === e)
            )
                return n;
            if (n === e) break;
...
function ot(n, t) {
    ...
    for (; (n = n.previousElementSibling); )
        n.nodeName.toUpperCase() !== 'TEMPLATE' && n !== v.clone && (!t || ve(n, t)) && e++;
    return e;
}
function Li(n) {
    var t = 0,
    ...
    $i = function (t) {
        function e(s, r) {
            return function (a, l, c, f) {
                ...
                return (
                    s === !0 || (typeof s == 'string' && s === p) || (s.join && s.indexOf(p) > -1)
                );
            };
        }
        var i = {},
...
function v(n, t) {
    ...
    ((this.nativeDraggable = t.forceFallback ? !1 : Hn),
        ...
        t.supportPointer
            ...
            : (O(n, 'mousedown', this._onTapStart), O(n, 'touchstart', this._onTapStart)),
...
v.prototype = {
        ...
        function y(B) {
            return (
                ...
                B &&
                    ...
                    g !== p &&
                        (Q(h, V ? V.options.ghostClass : c.options.ghostClass, !1),
                        Q(h, a.ghostClass, !0)),
        ...
        if (
            ...
            if (!A || (Yn(t, u, this) && !A.animated)) {
                ...
                if (
                    ...
                    return (
                        E(),
                        A && A.nextSibling ? e.insertBefore(h, A.nextSibling) : e.appendChild(h),
                        (R = e),
                        D(),
                        y(!0)
                    );
    ...
    toArray: function () {
        for (var t = [], e, i = this.el.children, o = 0, s = i.length, r = this.options; o < s; o++)
            ((e = i[o]),
                lt(e, r.draggable, this.el, !1) && t.push(e.getAttribute(r.dataIdAttr) || jn(e)));
        return t;
    },
    sort: function (t, e) {
        var i = {},
...
function Un(n, t, e, i, o, s, r, a) {
    ...
    if (!r) {
        if (a && ge < c * o) {
            if ((!Qt && (Jt === 1 ? l > f + (c * s) / 2 : l < d - (c * s) / 2) && (Qt = !0), Qt))
                p = !0;
    ...
    return (
        (p = p || r),
        p && (l < f + (c * s) / 2 || l > d - (c * s) / 2) ? (l > f + c / 2 ? 1 : -1) : 0
    );
}
function Gn(n) {
...
function jn(n) {
    for (
        var t = n.tagName + n.className + n.src + n.href + n.textContent, e = t.length, i = 0;
        e--;
    )
        i += t.charCodeAt(e);
...
var He = Bi(function (n, t, e, i) {
        if (t.scroll) {
            var o = (n.touches ? n.touches[0] : n).clientX,
                ...
                f;
            ze !== e &&
                ((ze = e), be(), (Yt = t.scroll), (f = t.scrollFn), Yt === !0 && (Yt = xt(e, !0)));
            var d = 0,
                p = Yt;
            do {
                var u = p,
...
var Ee = class {
                ...
                ((this.refreshOptionLabelListener = async (t) => {
                    if (
                        ...
                        try {
                            ...
                            (P(i) && (this.isHtmlAllowed ? (i.innerHTML = e) : (i.textContent = e)),
    ...
    async addSingleBadge(t, e) {
        ...
        if (
            (bt(i) && ((i = this.getSelectedOptionLabel(t)), P(i) && (this.labelRepository[t] = i)),
