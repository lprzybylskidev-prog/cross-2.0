...
var Mc = (s, t, e) =>
    t in s ? Sc(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : (s[t] = e);
...
function zc(s) {
    ...
    let n = Ho(+t[2]),
        ...
        r = +t[4] / 100;
    return (
        t[1] === 'hwb' ? (i = Rc(n, o, r)) : t[1] === 'hsv' ? (i = Nc(n, o, r)) : (i = Xi(n, o, r)),
        { r: i[0], g: i[1], b: i[2], a: e }
    );
}
function Vc(s, t) {
    var e = qi(s);
    ((e[0] = Ho(e[0] + t)), (e = Xi(e)), (s.r = e[0]), (s.g = e[1]), (s.b = e[2]));
}
function Wc(s) {
    if (!s) return;
    let t = qi(s),
        ...
        i = No(t[1]),
        n = No(t[2]);
    return s.a < 255 ? `hsla(${e}, ${i}%, ${n}%, ${Nt(s.a)})` : `hsl(${e}, ${i}%, ${n}%)`;
}
var zo = {
        x: 'dark',
        Z: 'light',
...
function Bc() {
    ...
    for (i = 0; i < t.length; i++) {
        for (r = a = t[i], n = 0; n < e.length; n++) ((o = e[n]), (a = a.replace(o, zo[o])));
        ((o = parseInt(Vo[r], 16)), (s[a] = [(o >> 16) & 255, (o >> 8) & 255, o & 255]));
    }
    return s;
}
var Ys;
...
function Uc(s) {
    return (
        s &&
        (s.a < 255 ? `rgba(${s.r}, ${s.g}, ${s.b}, ${Nt(s.a)})` : `rgb(${s.r}, ${s.g}, ${s.b})`)
    );
}
var Yi = (s) => (s <= 0.0031308 ? s * 12.92 : Math.pow(s, 1 / 2.4) * 1.055 - 0.055),
...
function Wo(s) {
    ...
    return (
        Array.isArray(s)
            ? s.length >= 3 &&
              ((t = { r: s[0], g: s[1], b: s[2], a: 255 }), s.length > 3 && (t.a = qt(s[3])))
...
var hs = class s {
    constructor(t) {
        ...
        let e = typeof t,
            i;
        (e === 'object' ? (i = Wo(t)) : e === 'string' && (i = Cc(t) || Hc(t) || Zc(t)),
            (this._rgb = i),
            (this._valid = !!i));
    }
    get valid() {
...
var er = (s, t) => (typeof s == 'string' && s.endsWith('%') ? parseFloat(s) / 100 : +s / t),
...
function Gc(s, t, e) {
    ...
    let i = t[s],
        n = e[s];
    E(i) && E(n) ? Ie(i, n) : Object.prototype.hasOwnProperty.call(t, s) || (t[s] = Js(n));
}
...
var ni = (s) => (s === 'start' ? 'left' : s === 'end' ? 'right' : 'center'),
    ...
    dr = (s, t, e, i) => (s === (i ? 'left' : 'right') ? e : s === 'center' ? (t + e) / 2 : t);
function un(s, t, e) {
    let i = t.length,
        n = 0,
        o = i;
    if (s._sorted) {
        ...
        if (f) {
            if (((n = Math.min(Ct(l, h, u).lo, e ? i : Ct(t, h, r.getPixelForValue(u)).lo)), c)) {
                let m = l
                    .slice(0, n + 1)
                    .reverse()
...
var qs = (s) => s === 0 || s === 1,
    Yo = (s, t, e) => -(Math.pow(2, 10 * (s -= 1)) * Math.sin(((s - t) * $) / e)),
...
function pn(s, t, e, i, n) {
    ...
    if (!(isNaN(m) || m <= 0)) {
        switch ((s.beginPath(), f)) {
            default:
                (n ? s.ellipse(e, i, n / 2, m, 0, 0, $) : s.arc(e, i, m, 0, $), s.closePath());
                break;
            case 'triangle':
                ((h = n ? n / 2 : m),
...
function _n(s, t, e, i) {
    ...
    return l === null || (typeof o < 'u' && o !== e && ((l = Go(a, r, o, l, i)), l === null))
        ? !1
...
function Sh(s, t, e, i) {
    let n;
    for (let o of t)
        if (((n = _r(bh(o, s), e)), typeof n < 'u')) return xn(s, n) ? _n(e, i, s, n) : n;
}
function _r(s, t) {
    for (let e of t) {
        if (!e) continue;
...
function wn(s, t, e, i) {
    let { iScale: n } = s,
        ...
        c,
        h;
    for (a = 0, l = i; a < l; ++a) ((c = a + e), (h = t[c]), (r[a] = { r: n.parse(Wt(h, o), c) }));
    return r;
}
...
function kr(s, t, e, i, n) {
    ...
    if ((t.spanGaps && (s = s.filter((c) => !c.skip)), t.cubicInterpolationMode === 'monotone'))
        ...
        for (o = 0, r = s.length; o < r; ++o)
            ((a = s[o]),
                (l = Th(c, a, s[Math.min(o + 1, r - (i ? 0 : 1)) % r], t.tension)),
                (a.cp1x = l.previous.x),
                (a.cp1y = l.previous.y),
                (a.cp2x = l.next.x),
                (a.cp2y = l.next.y),
        ...
        ((y = t[M % r]),
            !y.skip &&
                ...
                b !== _ &&
                    ...
                    p !== null &&
                        S() &&
                        (g.push(Jo({ start: p, end: M, loop: d, count: r, style: f })), (p = null)),
                    (T = M),
                    (_ = b))));
    return (p !== null && g.push(Jo({ start: p, end: u, loop: d, count: r, style: f })), g);
}
function Tn(s, t) {
    let e = [],
        i = s.segments;
...
var An = (s) => s === 'reset' || s === 'none',
    ...
    su = (s, t, e) => s && !t.hidden && t._stacked && { keys: Da(e, !0), values: null },
    ut = class {
        constructor(t, e) {
            ((this.chart = t),
                (this._ctx = t.ctx),
        ...
        buildOrUpdateElements(t) {
            ...
            ((e._stacked = Cn(e.vScale, e)),
                ...
                (n || o !== e._stacked) && (Er(this, e._parsed), (e._stacked = Cn(e.vScale, e))));
        }
        configure() {
        ...
        parsePrimitiveData(t, e, i, n) {
            let { iScale: o, vScale: r } = t,
                ...
                g;
            for (d = 0, f = n; d < f; ++d)
                ((g = d + i), (u[d] = { [a]: h || o.parse(c[g], g), [l]: r.parse(e[g], g) }));
            return u;
        }
        ...
        applyStack(t, e, i) {
            let n = this.chart,
                o = this._cachedMeta,
                r = e[t.axis],
                a = { keys: Da(n, !0), values: e._stacks[t.axis]._visualValues };
        ...
        _update(t) {
            ...
            (this.update(t || 'default'),
                (e._clip = Gh(
                    P(this.options.clip, qh(e.xScale, e.yScale, this.getMaxOverflow()))
                )));
        }
        update(t) {}
        draw() {
        ...
        _resolveElementOptions(t, e = 'default', i) {
            ...
            return (m.$shared && ((m.$shared = l), (o[r] = Object.freeze(Lr(m, l)))), m);
        }
...
(v(ut, 'defaults', {}), v(ut, 'datasetElementType', null), v(ut, 'dataElementType', null));
function iu(s, t) {
    if (!s._cache.$bar) {
...
function ou(s, t, e, i) {
    let n = e.barThickness,
        ...
        r;
    return (
        I(n) ? ((o = t.min * e.categoryPercentage), (r = e.barPercentage)) : ((o = n * i), (r = 1)),
...
function Fr(s, t, e, i) {
    let n = s.iScale,
        ...
        d;
    for (c = e, h = e + i; c < h; ++c)
        ((d = t[c]), (u = {}), (u[n.axis] = a || n.parse(r[c], c)), l.push(Ca(d, u, o, c)));
    return l;
}
function In(s) {
...
var We = class extends ut {
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            ...
            o = this.getParsed(t),
            r = o._custom,
            a = In(r) ? '[' + r.start + ', ' + r.end + ']' : '' + n.getLabelForValue(o[n.axis]);
    ...
    updateElements(t, e, i, n) {
        ...
        for (let f = e; f < e + i; f++) {
            let g = this.getParsed(f),
                m = o || I(g[a.axis]) ? { base: l, head: l } : this._calculateBarValuePixels(f),
                p = this._calculateBarIndexPixels(f, h),
                b = (g._stacks || {})[a.axis],
                y = {
                    horizontal: c,
                    base: m.base,
                    enableBorderRadius: !b || In(g._custom) || r === b._top || r === b._bottom,
                    x: c ? m.head : p.center,
                    y: c ? p.center : m.head,
            ...
            (hu(y, _, b, r), du(y, _, h.ratio), this.updateElement(t[f], f, y, n));
        }
    }
    _getStacks(t, e) {
    ...
    _calculateBarIndexPixels(t, e) {
        ...
        if (e.grouped) {
            let h = o ? this._getStackCount(t) : e.stackCount,
                u = n.barThickness === 'flex' ? ru(t, e, n, h * c) : ou(t, e, n, h * c),
                d =
...
var Be = class extends ut {
    ...
    parseObjectData(t, e, i, n) {
        ...
        for (let r = 0; r < o.length; r++) {
            let a = e[i + r];
            o[r]._custom = P(a && a.r && +a.r, this.resolveDataElementOptions(r + i).radius);
        }
        return o;
    }
    getMaxOverflow() {
    ...
    resolveDataElementOptions(t, e) {
        ...
        let o = n.radius;
        return (e !== 'active' && (n.radius = 0), (n.radius += P(i && i._custom, o)), n);
    }
};
(v(Be, 'id', 'bubble'),
    v(Be, 'defaults', {
    ...
    v(Be, 'overrides', { scales: { x: { type: 'linear' }, y: { type: 'linear' } } }));
function fu(s, t, e) {
    let i = 1,
        n = 1,
        o = 0,
    ...
    if (t < $) {
        let a = s,
            ...
            b = g(F, c, u),
            y = g(F + q, h, d);
        ((i = (m - b) / 2), (n = (p - y) / 2), (o = -(m + b) / 2), (r = -(p + y) / 2));
    }
    ...
    updateElements(t, e, i, n) {
        ...
        for (let x = 0; x < _; ++x) {
            ...
            ((S.skip = isNaN(C) || isNaN(A) || T),
                ...
                u && (S.options = h || this.resolveDataElementOptions(x, k.active ? 'active' : n)),
...
(v(He, 'id', 'line'),
    ...
    v(He, 'overrides', { scales: { _index_: { type: 'category' }, _value_: { type: 'linear' } } }));
...
(v(vs, 'id', 'pie'),
    v(vs, 'defaults', { cutout: 0, rotation: 0, circumference: 360, radius: '100%' }));
...
(v($e, 'id', 'radar'),
    ...
    v($e, 'overrides', { aspectRatio: 1, scales: { r: { type: 'radialLinear' } } }));
    ...
    updateElements(t, e, i, n) {
        ...
        for (let w = e; w < e + i; ++w) {
            ...
            ((S.skip = isNaN(T) || isNaN(C) || M),
                ...
                d && (S.options = u || this.resolveDataElementOptions(w, x.active ? 'active' : n)),
...
(v(je, 'id', 'scatter'),
    v(je, 'defaults', { datasetElementType: !1, dataElementType: 'point', showLine: !1, fill: !1 }),
    v(je, 'overrides', {
...
function Ss(s, t, e, i) {
    ...
    for (o = 0, r = s.length, c = 0; o < r; ++o) {
        ((a = s[o]), (l = a.box), l.update(a.width || t.w, a.height || t.h, Ou(a.horizontal, t)));
...
function Iu(s, t, e) {
    let i = s.canvas,
        n = new MutationObserver((o) => {
            let r = !1;
            for (let a of o) ((r = r || ki(a.addedNodes, i)), (r = r && !ki(a.removedNodes, i)));
            r && e();
        });
...
function Eu(s, t, e) {
    let i = s.canvas,
        n = new MutationObserver((o) => {
            let r = !1;
            for (let a of o) ((r = r || ki(a.removedNodes, i)), (r = r && !ki(a.addedNodes, i)));
            r && e();
        });
    return (n.observe(document, { childList: !0, subtree: !0 }), n);
}
...
var jn = class extends wi {
    ...
    removeEventListener(t, e) {
        let i = t.$proxies || (t.$proxies = {}),
            n = i[e];
        if (!n) return;
        ((({ attach: Fn, detach: Fn, resize: Fn })[e] || Pu)(t, e, n), (i[e] = void 0));
    }
    getDevicePixelRatio() {
...
function zu(s) {
    return !ci() || (typeof OffscreenCanvas < 'u' && s instanceof OffscreenCanvas) ? $n : jn;
}
var dt = class {
    constructor() {
        v(this, 'x');
...
function Ju(s, t, e, i) {
    ...
    if (s.isHorizontal()) {
        ...
        } else e === 'center' ? (g = (c.bottom + c.top) / 2 + m - t) : (g = jr(s, e, t));
        d = a - o;
    } else {
        if (E(e)) {
            let b = Object.keys(e)[0],
        ...
        } else e === 'center' ? (f = (c.left + c.right) / 2 - p + t) : (f = jr(s, e, t));
...
var we = class s extends dt {
            ...
            for (u = 0; u < e; u += l) {
                if (
                    ...
                    for (d = 0, f = g.length; d < f; ++d)
                        ((x = g[d]), !I(x) && !H(x) && ((_ = fs(n, b.data, b.gc, _, x)), (w += y)));
        ...
        getContext(t) {
            ...
            return this.$context || (this.$context = qu(this.chart.getContext(), this));
        }
        _tickSize() {
        ...
        drawTitle() {
            ...
            e === 'bottom' || e === 'center' || E(e)
                ? ((l += r.bottom), H(i.text) && (l += o.lineHeight * (i.text.length - 1)))
                : (l += r.top);
            let { titleX: c, titleY: h, maxWidth: u, rotation: d } = Ju(this, l, e, a);
            Qt(t, i.text, 0, 0, o, {
                color: i.color,
                maxWidth: u,
                rotation: d,
    ...
    Ze = class {
        ...
        register(t) {
            ...
            return (
                o in n || ((n[o] = t), Ku(t, r, i), this.override && j.override(t.id, t.overrides)),
                r
            );
        }
        get(t) {
...
function id(s, { plugins: t, localIds: e }, i, n) {
    ...
    for (let a of t) {
        let l = a.id,
            c = sd(i[l], n);
        c !== null &&
            o.push({ plugin: a, options: nd(s.config, { plugin: a, local: e[l] }, c, r) });
    }
    return o;
}
...
function qn(s, ...t) {
    if (qr(s)) return s;
    for (let e of t) {
        let i = e.axis || ad(e.position) || (s.length > 1 && qr(s[0].toLowerCase()));
        if (i) return i;
    }
    throw new Error(
    ...
    return (
        ...
        s.data.datasets.forEach((r) => {
            ...
            Object.keys(h).forEach((u) => {
                let d = od(u, l),
                    f = r[d + 'AxisID'] || d;
                ((o[f] = o[f] || Object.create(null)), Ie(o[f], [{ axis: d }, i[f], h[u]]));
            });
        }),
...
var ks = (s, t, e) => {
    ...
    Gn = class {
        ...
        getOptionScopes(t, e, i) {
            ...
            let c = Array.from(l);
            return (c.length === 0 && c.push(Object.create(null)), Ra.has(e) && r.set(e, c), c);
        }
        chartOptionScopes() {
...
var yt = class {
    ...
    _initialize() {
        return (
            ...
            this.options.responsive ? this.resize() : kn(this, this.options.devicePixelRatio),
            this.bindEvents(),
    ...
    resize(t, e) {
        Ht.running(this) ? (this._resizeBeforeDraw = { width: t, height: e }) : this._resize(t, e);
    }
    _resize(t, e) {
        let i = this.options,
            n = this.canvas,
        ...
        (e &&
            ...
            z(o, (r) => {
                let a = r.options,
                    ...
                    c = qn(l, a),
                    h = P(a.type, r.dtype);
                ((a.position === void 0 || Kr(a.position, c) !== Kr(r.dposition)) &&
    ...
    setActiveElements(t) {
        ...
        !gs(i, e) && ((this._active = i), (this._lastEvent = null), this._updateHoverStyles(i, e));
    }
    notifyPlugins(t, e, i) {
...
function xd(s, t, e) {
    ...
    (s.beginPath(),
        s.arc(o, r, a, i - c, e + c),
        l > n ? ((c = n / l), s.arc(o, r, l, e + c, i - c, !0)) : s.arc(o, r, n, e + q, i - q),
        s.closePath(),
        s.clip());
}
function _d(s) {
...
function vi(s, t, e, i, n, o) {
    ...
    let m = Math.max(0.001, g * u - e / F) / u,
        ...
        b = l + p + f,
        y = n - p - f,
        { outerStart: _, outerEnd: w, innerStart: x, innerEnd: k } = wd(t, d, u, y - b),
        S = u - _,
        M = u - w,
        T = b + _ / S,
        C = y - w / M,
    ...
    if ((s.beginPath(), o)) {
        ...
        let G = (y - k / d + (b + x / d)) / 2;
        if ((s.arc(r, a, d, y - k / d, G, !0), s.arc(r, a, d, G, b + x / d, !0), x > 0)) {
            let ot = Ve(A, et, r, a);
...
(v(be, 'id', 'arc'),
    ...
    v(be, 'descriptors', { _scriptable: !0, _indexable: (e) => e !== 'borderDash' }));
function za(s, t, e = t) {
...
function Md(s) {
    return s.stepped ? mr : s.tension || s.cubicInterpolationMode === 'monotone' ? pr : Sd;
}
function Va(s, t, e = {}) {
    let i = s.length,
...
function Od(s, t, e, i) {
    ...
    for (f = 0; f <= c; ++f)
        ((g = n[(a + (d ? c - f : f)) % r]),
            !g.skip && (u ? (s.moveTo(g.x, g.y), (u = !1)) : h(s, m, g, d, o.stepped), (m = g)));
...
function Dd(s) {
    return s.stepped ? Mr : s.tension || s.cubicInterpolationMode === 'monotone' ? Or : Gt;
}
function Cd(s, t, e, i) {
    let n = t._path;
...
var Ft = class extends dt {
    ...
    draw(t, e, i, n) {
        let o = this.options || {};
        ((this.points || []).length && o.borderWidth && (t.save(), Id(t, this, i, n), t.restore()),
...
(v(Ft, 'id', 'line'),
    ...
    v(Ft, 'defaultRoutes', { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }),
    v(Ft, 'descriptors', {
        _scriptable: !0,
...
(v(Ue, 'id', 'point'),
    ...
    v(Ue, 'defaultRoutes', { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }));
function Wa(s, t) {
    let {
            x: e,
            y: i,
...
(v(Ye, 'id', 'bar'),
    ...
    v(Ye, 'defaultRoutes', { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }));
...
function Hd(s) {
    ...
    return (e, i) => {
        ...
        n instanceof jt ? (t = Wd(e, t)) : n instanceof xe ? (t = Bd(e, t)) : n && (t = Vd(e, t));
    };
}
function oa(s) {
    let t;
...
function Zd(s, t, e, i) {
    ...
    for (r = t; r < t + e; ++r) {
        ...
        let x = l | 0;
        if (x === h)
            (c < g ? ((g = c), (u = r)) : c > m && ((m = c), (d = r)), (n = (o * n + a.x) / ++o));
        else {
            let k = r - 1;
            if (!I(u) && !I(d)) {
                let S = Math.min(u, d),
...
function Kn(s, t, e, i) {
    ...
    let n = t[s],
        o = e[s];
    return (s === 'angle' && ((n = st(n)), (o = st(o))), { property: s, start: n, end: o });
}
function Jd(s, t) {
...
function ja(s, t) {
    ...
    return (
        ...
        e.length ? new Ft({ points: e, options: { tension: 0 }, _loop: i, _fullLoop: i }) : null
    );
}
function la(s) {
    return s && s.fill !== !1;
...
var Si = class {
    ...
    pathSegment(t, e, i) {
        ...
        return ((e = e || { start: 0, end: $ }), t.arc(n, o, r, e.end, e.start, !0), !i.bounds);
    }
    interpolate(t) {
...
function ff(s) {
    ...
    if (i.grid.circular) {
        ...
        return new Si({ x: l.x, y: l.y, radius: t.getDistanceFromCenterForValue(r) });
    }
...
function zn(s, t, e) {
    ...
    i &&
        r.points.length &&
        (ps(s, e),
        gf(s, { line: r, target: i, above: d, below: f, area: e, scale: a, axis: l, clip: m }),
        bs(s));
}
function gf(s, t) {
    ...
    (o !== n &&
        (c === 'x'
            ? (ca(s, i, r.top),
              Vn(s, { line: e, target: i, color: n, scale: a, property: c, clip: l }),
              s.restore(),
              s.save(),
              ca(s, i, r.bottom))
            : c === 'y' &&
              (ha(s, i, r.left),
              Vn(s, { line: e, target: i, color: o, scale: a, property: c, clip: l }),
              s.restore(),
              s.save(),
              ha(s, i, r.right),
              (h = n))),
...
function Vn(s, t) {
    ...
    for (let { source: c, target: h, start: u, end: d } of l) {
        let { style: { backgroundColor: f = o } = {} } = c,
            g = i !== !0;
        (s.save(), (s.fillStyle = f), mf(s, r, a, g && Kn(n, u, d)), s.beginPath());
...
var pf = {
        ...
        afterDatasetsUpdate(s, t, e) {
            ...
            for (r = 0; r < i; ++r)
                ((o = s.getDatasetMeta(r)),
                    ...
                    n.push(l));
            for (r = 0; r < i; ++r)
                ((l = n[r]), !(!l || l.fill === !1) && (l.fill = Kd(n, r, e.propagate)));
        },
        beforeDraw(s, t, e) {
            ...
            for (let r = n.length - 1; r >= 0; --r) {
                let a = n[r].$filler;
                a && (a.line.updateControlPoints(o, a.axis), i && a.fill && zn(s.ctx, a, o));
            }
        },
        ...
        beforeDatasetDraw(s, t, e) {
            let i = t.meta.$filler;
            !la(i) || e.drawTime !== 'beforeDatasetDraw' || zn(s.ctx, i, s.chartArea);
        },
    ...
    Mi = class extends dt {
        ...
        adjustHitBoxes() {
            ...
            if (this.isHorizontal()) {
                ...
                for (let c of e)
                    (a !== c.row &&
                        ((a = c.row), (l = it(i, this.left + n, this.right - this.lineWidths[a]))),
                        (c.top += this.top + t + n),
        ...
        _draw() {
            ...
            (_
                ? (f = { x: it(o, this.left + h, this.right - i[0]), y: this.top + h + w, line: 0 })
                : (f = {
                      x: this.left + h,
                ...
                (l.setWidth(this.width),
                    _
                        ...
                        : S > 0 &&
                          ...
                          f.line++,
                          (L = f.y = it(o, this.top + w + h, this.bottom - e[f.line].height))));
                let et = l.x(A);
                if (
                    (b(et, L, k),
...
var Ps = class extends dt {
    ...
    getContext() {
        return (
            this.$context || (this.$context = If(this.chart.getContext(), this, this._tooltipItems))
        );
    }
    getTitle(t, e) {
        let { callbacks: i } = e,
    ...
    drawBackground(t, e, i, n) {
        let { xAlign: o, yAlign: r } = this,
            { x: a, y: l } = t,
            { width: c, height: h } = i,
            { topLeft: u, topRight: d, bottomLeft: f, bottomRight: g } = te(n.cornerRadius);
        ((e.fillStyle = n.backgroundColor),
            (e.strokeStyle = n.borderColor),
            (e.lineWidth = n.borderWidth),
            e.beginPath(),
...
var Os = class extends we {
    ...
    parse(t, e) {
        ...
        let i = this.getLabels();
        return (
            (e = isFinite(e) && i[e] === t ? e : Rf(i, t, P(e, t), this._addedLabels)),
            Nf(e, i.length - 1)
        );
    }
    determineDataLimits() {
...
function zf(s, t) {
    ...
    ((T = Math.ceil(p / x) - Math.floor(m / x)),
        ...
        b && y && o && or((a - r) / o, x / 1e3)
            ? ((T = Math.round(Math.min((a - r) / x, h))), (x = (a - r) / T), (S = r), (M = a))
            : _
              ? ((S = b ? r : S), (M = y ? a : M), (T = c - 1), (x = (M - S) / T))
              : ((T = (M - S) / x),
                Le(T, Math.round(T), x / 1e3) ? (T = Math.round(T)) : (T = Math.ceil(T))));
    let C = Math.max(on(x), on(S));
    ((k = Math.pow(10, I(l) ? C : l)), (S = Math.round(S * k) / k), (M = Math.round(M * k) / k));
    let A = 0;
    for (
        b &&
        (d && S !== r
...
(v(Ts, 'id', 'linear'), v(Ts, 'defaults', { ticks: { callback: ms.formatters.numeric } }));
...
(v(Ds, 'id', 'logarithmic'),
    v(Ds, 'defaults', { ticks: { callback: ms.formatters.logarithmic, major: { enabled: !0 } } }));
function Qn(s) {
    let t = s.ticks;
...
function Bf(s, t, e) {
    return ((e = H(e) ? e : [e]), { w: gr(s, t.string, e), h: e.length * t.lineHeight });
}
...
function Yf(s, t, e) {
    ...
    for (let h = 0; h < n; h++) {
        ...
        let u = jf(s, h, l);
        (i.push(u), a === 'auto' && ((u.visible = Uf(u, c)), u.visible && (c = u)));
    }
    return i;
}
function Zf(s) {
...
var ye = class extends qe {
    ...
    fit() {
        let t = this.options;
        t.display && t.pointLabels.display ? Hf(this) : this.setCenterPoint(0, 0, 0, 0);
    }
...
function eg(s) {
    for (let t = ct.indexOf(s) + 1, e = ct.length; t < e; ++t) if (Ti[ct[t]].common) return ct[t];
}
function Oa(s, t, e) {
    if (!e) s[t] = !0;
    else if (e.length) {
...
var _e = class extends we {
    ...
    buildTicks() {
        ...
        return (
            (this._unit =
                e.unit ||
                (i.autoSkip
                    ? Ma(e.minUnit, this.min, this.max, this._getLabelCapacity(o))
                    : tg(this, a.length, e.minUnit, this.min, this.max))),
            (this._majorUnit = !i.major.enabled || this._unit === 'year' ? void 0 : eg(this._unit)),
            this.initOffsets(n),
            t.reverse && a.reverse(),
    ...
    _getLabelCapacity(t) {
        let e = this.options.time,
            ...
            o = this._tickFormatFunction(t, 0, Ta(this, [t], this._majorUnit), n),
...
var Yt = class extends Error {},
    ...
    Bl = { year: O, month: mt, day: O, hour: O, minute: O, second: O, timeZoneName: Dt },
    Hl = { year: O, month: mt, day: O, weekday: mt, hour: O, minute: O, timeZoneName: mt },
    $l = {
        year: O,
        month: mt,
        day: O,
...
function po(s, t = {}) {
    let e = JSON.stringify([s, t]),
        i = mo.get(e);
    return (i === void 0 && ((i = new Intl.DateTimeFormat(s, t)), mo.set(e, i)), i);
}
var bo = new Map();
function ug(s, t = {}) {
    let e = JSON.stringify([s, t]),
        i = bo.get(e);
    return (i === void 0 && ((i = new Intl.NumberFormat(s, t)), bo.set(e, i)), i);
}
var yo = new Map();
function dg(s, t = {}) {
    let { base: e, ...i } = t,
        ...
        o = yo.get(n);
    return (o === void 0 && ((o = new Intl.RelativeTimeFormat(s, t)), yo.set(n, o)), o);
}
var Rs = null;
function fg() {
...
function jl(s) {
    let t = xo.get(s);
    return (t === void 0 && ((t = new Intl.DateTimeFormat(s).resolvedOptions()), xo.set(s, t)), t);
}
var _o = new Map();
function gg(s) {
    let t = _o.get(s);
...
var wo = class {
        constructor(t, e, i) {
            ...
            if (!e || Object.keys(r).length > 0) {
                ...
                (i.padTo > 0 && (a.minimumIntegerDigits = i.padTo), (this.inf = ug(t, a)));
            }
        }
        format(t) {
            if (this.inf) {
    ...
    vo = class {
        constructor(t, e, i) {
            ((this.opts = { style: 'long', ...i }), !e && Kl() && (this.rtf = dg(t, i)));
        }
        format(t, e) {
            return this.rtf
                ? this.rtf.format(t, e)
    ...
    B = class s {
        ...
        static resetCache() {
            ((Rs = null), mo.clear(), bo.clear(), yo.clear(), xo.clear(), _o.clear());
        }
        static fromObject({
            locale: t,
            numberingSystem: e,
        ...
        constructor(t, e, i, n, o) {
            ...
            ((this.locale = r),
                ...
                (this.weekSettings = n),
                (this.intl = pg(this.locale, this.numberingSystem, this.outputCalendar)),
        ...
        get fastNumbers() {
            return (
                this.fastNumbersCached == null && (this.fastNumbersCached = xg(this)),
            ...
            return Di(this, t, rc, () => {
                ...
                return (
                    this.weekdaysCache[n][t] ||
                        (this.weekdaysCache[n][t] = yg((o) => this.extract(o, i, 'weekday'))),
                    this.weekdaysCache[n][t]
                );
            });
        }
        ...
        getWeekSettings() {
            return this.weekSettings ? this.weekSettings : Ql() ? gg(this.locale) : Ul;
        }
        getStartOfWeek() {
    ...
    kt = class s extends Me {
        ...
        get ianaName() {
            return this.fixed === 0 ? 'Etc/UTC' : `Etc/GMT${Vs(-this.fixed, 'narrow')}`;
        }
        offsetName() {
            return this.name;
        }
...
function ol(s, t = 4, e = 1) {
    let { weekYear: i, weekNumber: n, weekday: o } = s,
        ...
        l = n * 7 + o - r - 7 + t,
        c;
    l < 1 ? ((c = i - 1), (l += Qe(c))) : l > a ? ((c = i + 1), (l -= Qe(i))) : (c = i);
...
function al(s, t) {
    if (!D(s.localWeekday) || !D(s.localWeekNumber) || !D(s.localWeekYear)) {
        if (!D(s.weekday) || !D(s.weekNumber) || !D(s.weekYear))
            throw new oe('Cannot mix locale-based week fields with ISO-based week fields');
        return (
...
function Xl(s) {
    ...
    return t ? (e ? (i ? !1 : _t('day', s.day)) : _t('month', s.month)) : _t('year', s.year);
}
function Jl(s) {
...
function Vi(s, t) {
    let e = Cg(t - 1, 12) + 1,
        i = s + (t - e) / 12;
    return e === 2 ? (Bs(i) ? 29 : 28) : [31, null, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][e - 1];
}
function $i(s) {
...
var nc = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
...
var Bg = {
    ...
    ft = class s {
        ...
        static parseFormat(t) {
            ...
            for (let r = 0; r < t.length; r++) {
                ...
                a === "'"
                    ? ((i.length > 0 || n) &&
                          o.push({ literal: n || /^\s+$/.test(i), val: i === '' ? "'" : i }),
                      (e = null),
                      (i = ''),
                      (n = !n))
                    : n || a === e
                ...
                r = (f) =>
                    t.isOffsetFixed && t.offset === 0 && f.allowZ
                        ...
                        : t.isValid
                          ...
                          : '',
                a = () => (i ? Rg(t) : o({ hour: 'numeric', hourCycle: 'h12' }, 'dayperiod')),
                l = (f, g) =>
                    i ? zg(t, f) : o(g ? { month: f } : { month: f, day: 'numeric' }, 'month'),
                c = (f, g) =>
                    i
                        ? Ng(t, f)
                        : o(
    ...
    cc = /[A-Za-z_+-]{1,256}(?::?\/[A-Za-z0-9_+-]{1,256}(?:\/[A-Za-z0-9_+-]{1,256})?)?/;
function is(...s) {
...
function Xg(s, t) {
    return [{ year: ts(s, t), month: ts(s, t + 1, 1), day: ts(s, t + 2, 1) }, null, t + 3];
}
function rs(s, t) {
    return [
        {
...
var tt = class s {
        ...
        toFormat(t, e = {}) {
            ...
            return this.isValid ? ft.create(this.loc, i).formatDurationFromString(this, t) : dl;
        }
        toHuman(t = {}) {
        ...
        plus(t) {
            ...
            let e = s.fromDurationLike(t),
                i = {};
            for (let n of Se)
                (ss(e.values, n) || ss(this.values, n)) && (i[n] = e.get(n) + this.get(n));
        ...
        mapUnits(t) {
            if (!this.isValid) return this;
            let e = {};
            for (let i of Object.keys(this.values)) e[i] = ec(t(this.values[i], i));
...
var es = class s {
        ...
        toLocaleString(t = Ri, e = {}) {
            return this.isValid ? ft.create(this.s.loc.clone(e), t).formatInterval(this) : Xe;
        }
        toISO(t) {
        ...
        toFormat(t, { separator: e = ' \u2013 ' } = {}) {
            return this.isValid ? `${this.s.toFormat(t)}${e}${this.e.toFormat(t)}` : Xe;
        }
        toDuration(t, e) {
            return this.isValid ? this.e.diff(this.s, t, e) : tt.invalid(this.invalidReason);
        }
        mapEndpoints(t) {
...
function Fm(s, t) {
    let e = Ot(t),
        ...
        u = Ot(t, '{2,4}'),
        d = Ot(t, '{4,6}'),
        f = (p) => ({ regex: RegExp(Lm(p.val)), deser: ([b]) => b, literal: !0 }),
        m = ((p) => {
    ...
    if (i) {
        ...
        for (let r in e)
            if (ss(e, r)) {
                ...
                (!a.literal && a.token && (n[a.token.val[0]] = a.deser(i.slice(o, o + l))),
                    (o += l));
            }
        return [i, n];
    } else return [i, {}];
...
function $m(s, t, e) {
    let { result: i, zone: n, specificOffset: o, invalidReason: r } = _c(s, t, e);
    return [i, n, o, r];
}
function wc(s, t) {
    if (!s) return null;
...
function lo(s) {
    return (
        s.localWeekData === null &&
            (s.localWeekData = zi(s.c, s.loc.getMinDaysInFirstWeek(), s.loc.getStartOfWeek())),
        s.localWeekData
    );
}
function ve(s, t) {
...
function xl(s, t) {
    let e = s.o,
        ...
        o = {
            ...
            year: i,
            month: n,
            day: Math.min(s.c.day, Vi(i, n)) + Math.trunc(t.days) + Math.trunc(t.weeks) * 7,
        },
        r = tt
            .fromObject({
...
function Je(s, t, e, i, n, o) {
    ...
    } else return R.invalid(new gt('unparsable', `the input "${n}" can't be parsed as ${i}`));
}
function Ai(s, t, e = !0) {
    return s.isValid
        ? ft
...
function co(s, t, e) {
    let i = s.c.year > 9999 || s.c.year < 0,
        n = '';
    if ((i && s.c.year >= 0 && (n += '+'), (n += J(s.c.year, i ? 6 : 4)), e === 'year')) return n;
    if (t) {
...
function _l(s, t, e, i, n, o, r) {
    ...
    switch (r) {
        ...
        default:
            ...
            if (r === 'second') break;
            a && (!i || s.c.millisecond !== 0) && ((l += '.'), (l += J(s.c.millisecond, 3)));
    }
    return (
        n &&
...
var vc = { month: 1, day: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
    jm = { weekNumber: 1, weekday: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
    ...
    R = class s {
        ...
        static local() {
            let [t, e] = Sl(arguments),
                [i, n, o, r, a, l, c] = e;
            return kl(
                { year: i, month: n, day: o, hour: r, minute: a, second: l, millisecond: c },
                t
            );
        }
        static utc() {
            ...
            return (
                ...
                kl({ year: i, month: n, day: o, hour: r, minute: a, second: l, millisecond: c }, t)
            );
        }
        static fromJSDate(t, e = {}) {
            ...
            return n.isValid ? new s({ ts: i, zone: n, loc: B.fromObject(e) }) : s.invalid(Ns(n));
        }
        static fromMillis(t, e = {}) {
            if (re(t))
                return t < -yl || t > yl
                    ? s.invalid('Timestamp out of range')
                    : new s({ ts: t, zone: ne(e.zone, Y.defaultZone), loc: B.fromObject(e) });
            throw new Q(
        ...
        static fromFormat(t, e, i = {}) {
            if (D(t) || D(e)) throw new Q('fromFormat requires an input string and a format');
        ...
        toLocaleString(t = Ri, e = {}) {
            return this.isValid ? ft.create(this.loc.clone(e), t).formatDateTime(this) : ro;
        }
        toLocaleParts(t = {}) {
        ...
        toISO({
            ...
            let a = t === 'extended',
                l = co(this, a, r);
            return (Ei.indexOf(r) >= 3 && (l += 'T'), (l += _l(this, a, e, i, n, o, r)), l);
        }
        ...
        toISOTime({
            ...
            return this.isValid
                ? ((a = Li(a)),
                  (n && Ei.indexOf(a) >= 3 ? 'T' : '') + _l(this, r === 'extended', e, t, i, o, a))
                : null;
        }
        toRFC2822() {
        ...
        toRelative(t = {}) {
            ...
            return (
                ...
                vl(e, this.plus(i), { ...t, numeric: 'always', units: n, unit: o })
            );
        }
        ...
        static min(...t) {
            if (!t.every(s.isDateTime)) throw new Q('min requires all arguments be DateTimes');
            return ll(t, (e) => e.valueOf(), Math.min);
        }
        static max(...t) {
            if (!t.every(s.isDateTime)) throw new Q('max requires all arguments be DateTimes');
        ...
        static fromFormatParser(t, e, i = {}) {
            if (D(t) || D(e))
                throw new Q('fromFormatParser requires an input string and a format parser');
            let { locale: n = null, numberingSystem: o = null } = i,
                r = B.fromOpts({ locale: n, numberingSystem: o, defaultToEN: !0 });
    ...
    return {
        ...
        initChart(n = null) {
            ...
            ((Mt.defaults.borderColor = o),
                (Mt.defaults.color = getComputedStyle(this.$refs.textColorElement).color),
            ...
            if (
                ...
                ((_ = e.scales).r ?? (_.r = {}),
                    ...
                    (k = e.scales.r.ticks).backdropColor ?? (k.backdropColor = 'transparent'));
            }
        ...
        destroy() {
            (this.resizeObserver && this.resizeObserver.disconnect(), this.getChart()?.destroy());
        },
    };
}
