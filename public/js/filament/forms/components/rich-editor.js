...
ge.prototype = {
    ...
    update: function (t, e, n) {
        var r = n && n != t ? this.remove(n) : this,
            o = r.find(t),
            i = r.content.slice();
        return (o == -1 ? i.push(n || t, e) : ((i[o + 1] = e), n && (i[o] = n)), new ge(i));
    },
    remove: function (t) {
        var e = this.find(t);
        if (e == -1) return this;
...
function sp(t, e, n) {
    if (n.openStart > t.depth) throw new Ft('Inserted content deeper than insertion position');
    if (t.depth - n.openStart != e.depth - n.openEnd) throw new Ft('Inconsistent open depths');
    return Sa(t, e, n, 0);
}
function Sa(t, e, n, r) {
    let o = t.index(r),
    ...
    if (o == e.index(r) && r < t.depth - n.openStart) {
        ...
        if (!n.openStart && !n.openEnd && t.depth == r && e.depth == r) {
            let s = t.parent,
                l = s.content;
            return $t(s, l.cut(0, t.parentOffset).append(n.content).append(l.cut(e.parentOffset)));
        } else {
...
function zn(t, e, n, r) {
    ...
    t && ((i = t.index(n)), t.depth > n ? i++ : t.textOffset && (Ht(t.nodeAfter, r), i++));
...
var Rr = class t {
        ...
        blockRange(e = this, n) {
            ...
            for (
                ...
                if (e.pos <= this.end(r) && (!n || n(this.node(r)))) return new Vt(this, e, r);
            return null;
        }
        sameParent(e) {
    ...
    ie = class t {
        constructor(e, n, r, o = J.none) {
            ((this.type = e), (this.attrs = n), (this.marks = o), (this.content = r || v.empty));
        }
        get children() {
...
var _t = class t {
    ...
    fillBefore(e, n = !1, r = 0) {
        ...
        function i(s, l) {
            ...
            if (a && (!n || a.validEnd)) return v.from(l.map((c) => c.createAndFill()));
...
var Ri = class {
        constructor(e, n, r) {
            ((this.hasDefault = Object.prototype.hasOwnProperty.call(r, 'default')),
                ...
                (this.validate =
                    typeof r.validate == 'string' ? bp(e, n, r.validate) : r.validate));
        }
        get isRequired() {
    ...
    $n = class t {
        ...
        create(e = null) {
            return !e && this.instance ? this.instance : new J(this, Na(this.attrs, e));
        }
        static compile(e, n) {
            let r = Object.create(null),
                o = 0;
    ...
    fn = class {
        constructor(e) {
            ...
            for (let o in this.marks) {
                let i = this.marks[o],
                    s = i.spec.excludes;
                i.excluded = s == null ? [i] : s == '' ? [] : fa(this, s.split(' '));
            }
...
var Xe = class t {
        ...
        static schemaRules(e) {
            ...
            for (let o in e.marks) {
                ...
                i &&
                    i.forEach((s) => {
                        (r((s = pa(s))), s.mark || s.ignore || s.clearMark || (s.mark = o));
                    });
            }
            for (let o in e.nodes) {
                ...
                i &&
                    i.forEach((s) => {
                        (r((s = pa(s))), s.node || s.ignore || s.mark || (s.node = o));
                    });
            }
            return n;
        }
    ...
    kp = { head: !0, noscript: !0, object: !0, script: !0, style: !0, title: !0 },
    Ia = { ol: !0, ul: !0 },
    Fn = 1,
    Di = 2,
    Hn = 4;
        ...
        inlineContext(e) {
            return this.type
                ...
                : this.content.length
                  ...
                  : e.parentNode && !Da.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
        }
    },
    Ir = class {
        constructor(e, n, r) {
            ...
            (o
                ? (i = new un(o.type, o.attrs, J.none, !0, n.topMatch || o.type.contentMatch, s))
                : r
        ...
        addTextNode(e, n) {
            let r = e.nodeValue,
                o = this.top,
                i = o.options & Di ? 'full' : this.localPreserveWS || (o.options & Fn) > 0,
...
var ct = class t {
    ...
    serializeNodeInner(e, n) {
        let { dom: r, contentDOM: o } = Er(Ti(n), this.nodes[e.type.name](e), null, e.attrs);
        if (o) {
            ...
            for (let l = 0; l < this.ranges.length; l += 3) {
                ...
                if (e <= u) {
                    ...
                    let p = e == (n < 0 ? a : u) ? null : Tp(l / 3, e - a),
                        m = e == a ? $a : e == u ? Ha : Pr;
                    return ((n < 0 ? e != a : e != u) && (m |= Fa), new Wn(h, m, p));
                }
                o += d - c;
            }
...
var Kn = class t extends ce {
    ...
    apply(e) {
        ...
        return ue.fromReplace(e, this.pos, this.pos + 1, new E(v.from(r), 0, n.isLeaf ? 0 : 1));
    }
    invert(e) {
        let n = e.nodeAt(this.pos);
        if (n) {
    ...
    for (let a = 0; a < i.childCount; a++) {
        ...
        if (!u) s.push(new ye(l, d, E.empty));
            ...
            for (let f = 0; f < c.marks.length; f++)
                n.allowsMarkType(c.marks[f].type) || t.step(new ut(l, d, c.marks[f]));
            if (o && c.isText && n.whitespace != 'pre') {
                let f,
                    h = /\r?\n|\r/g,
                    p;
                for (; (f = h.exec(c.text)); )
                    (p || (p = new E(v.from(n.schema.text(' ', n.allowedMarks(c.marks))), 0, 0)),
                        s.push(new ye(l + f.index, l + f.index + f[0].length, p)));
            }
        }
        l = d;
    }
...
function Rp(t, e, n) {
    ...
    for (let p = i, m = !1; p > n; p--)
        m || r.index(p) > 0 ? ((m = !0), (d = v.from(r.node(p).copy(d))), u++) : a--;
    let f = v.empty,
        h = 0;
    for (let p = i, m = !1; p > n; p--)
        m || o.after(p + 1) < o.end(p) ? ((m = !0), (f = v.from(o.node(p).copy(f))), h++) : c++;
...
function Lp(t, e, n, r, o) {
    ...
    t.doc.nodesBetween(e, n, (s, l) => {
        ...
        if (s.isTextblock && !s.hasMarkup(r, a) && Bp(t.doc, t.mapping.slice(i).map(l), r)) {
            let c = null;
...
function zp(t, e, n, r, o) {
    ...
    t.step(new se(e, e + i.nodeSize, e + 1, e + i.nodeSize - 1, new E(v.from(s), 0, 0), 1, !0));
}
...
function Fp(t, e, n) {
    ...
    s.inlineContent && $i(t, e + n - 1, s, i.node().contentMatchAt(i.index()), r == null);
...
var zi = class {
    constructor(e, n, r) {
        ...
        for (let o = e.depth; o > 0; o--) this.placed = v.from(e.node(o).copy(this.placed));
    }
    get depth() {
        ...
        for (let n = 1; n <= 2; n++)
            for (let r = n == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
                let o,
                    i = null;
                r
                    ? ((i = Pi(this.unplaced.content, r - 1).firstChild), (o = i.content))
    ...
    placeNodes({ sliceDepth: e, frontierDepth: n, parent: r, inject: o, wrap: i }) {
        ...
        this.unplaced = p
            ? e == 0
                ? E.empty
                : new E(Vn(s.content, e - 1, 1), e - 1, h < 0 ? s.openEnd : e - 1)
    ...
    close(e) {
        ...
        (n.fit.childCount && (this.placed = _n(this.placed, n.depth, n.fit)), (e = n.move));
    ...
    closeFrontierNode() {
        ...
        n.childCount && (this.placed = _n(this.placed, this.frontier.length, n));
    }
};
function Vn(t, e, n) {
    return e == 0
        ? t.cutByIndex(n, t.childCount)
        : t.replaceChild(0, t.firstChild.copy(Vn(t.firstChild.content, e - 1, n)));
}
function _n(t, e, n) {
    return e == 0
        ? t.append(n)
        : t.replaceChild(t.childCount - 1, t.lastChild.copy(_n(t.lastChild.content, e - 1, n)));
}
function Pi(t, e) {
...
function Ua(t, e, n) {
    ...
    let r = t.content;
    return (
        e > 1 && (r = r.replaceChild(0, Ua(r.firstChild, e - 1, r.childCount == 1 ? n - 1 : 0))),
        e > 0 &&
            ((r = t.type.contentMatch.fillBefore(r).append(r)),
            n <= 0 && (r = r.append(t.type.contentMatch.matchFragment(r).fillBefore(v.empty, !0)))),
        t.copy(r)
    );
}
...
var Lr = class t extends ce {
    ...
    apply(e) {
        ...
        return ue.fromReplace(e, this.pos, this.pos + 1, new E(v.from(o), 0, n.isLeaf ? 0 : 1));
    }
    getMap() {
        return dt.empty;
    }
    ...
    removeNodeMark(e, n) {
        ...
        if (n instanceof J) n.isInSet(r.marks) && this.step(new hn(e, n));
            ...
            let o = r.marks,
                i,
                s = [];
            for (; (i = n.isInSet(o)); ) (s.push(new hn(e, i)), (o = i.removeFromSet(o)));
    ...
    I = class {
        ...
        replace(e, n = E.empty) {
            ...
            for (let l = 0; l < s.length; l++) {
                ...
                (e.replaceRange(d.map(a.pos), d.map(c.pos), l ? E.empty : n),
                    l == 0 && Xa(e, i, (r ? r.isInline : o && o.isTextblock) ? -1 : 1));
            }
        }
        replaceWith(e, n) {
        ...
        static findFrom(e, n, r = !1) {
            ...
            for (let i = e.depth - 1; i >= 0; i--) {
                let s =
                    n < 0
                        ? gn(e.node(0), e.node(i), e.before(i + 1), e.index(i), n, r)
                        : gn(e.node(0), e.node(i), e.after(i + 1), e.index(i) + 1, n, r);
                if (s) return s;
            }
            return null;
        }
        ...
        static jsonID(e, n) {
            if (e in Fi) throw new RangeError('Duplicate use of selection JSON ID ' + e);
...
var Ya = 1,
    ...
    Wi = class extends Tt {
        ...
        addStep(e, n) {
            (super.addStep(e, n), (this.updated = this.updated & ~Hr), (this.storedMarks = null));
        }
        setTime(e) {
...
function ec(t, e, n) {
    for (let r in t) {
        let o = t[r];
        (o instanceof Function ? (o = o.bind(e)) : r == 'handleDOMEvents' && (o = ec(o, e, {})),
            (n[r] = o));
    }
    return n;
}
...
var Vr = (t, e) => (t.selection.empty ? !1 : (e && e(t.tr.deleteSelection().scrollIntoView()), !0));
function rc(t, e) {
...
function sc(t, e, n) {
    ...
    if (!c || c.from != i || (c instanceof ye && c.slice.size >= a - i)) return !1;
    if (n) {
        let d = t.tr.step(c);
...
var Zi = (t, e) => {
    ...
    es = (t, e) => {
        let n = t.selection,
            { $from: r, $to: o } = n;
        if (n instanceof ke || r.parent.inlineContent || o.parent.inlineContent) return !1;
    ...
    ts = (t, e) => {
        ...
        if (n.depth > 1 && n.after() != n.end(-1)) {
            let i = n.before();
            if (Ee(t.doc, i)) return (e && e(t.tr.split(i).scrollIntoView()), !0);
        }
        let r = n.blockRange(),
            o = r && ft(r);
...
function Gp(t) {
    return (e, n) => {
        ...
        let d = e.tr;
        (e.selection instanceof D || e.selection instanceof ke) && d.deleteSelection();
        let u = d.mapping.map(r.pos),
            f = Ee(d.doc, u, i.length, i);
        if ((f || ((i[0] = l ? { type: l } : null), (f = Ee(d.doc, u, i.length, i))), !f))
            return !1;
...
function Qp(t, e, n) {
    ...
    return !r || !o || !r.type.compatibleContent(o.type)
        ...
        : !r.content.size && e.parent.canReplace(i - 1, i)
          ...
          : !e.parent.canReplace(i, i + 1) || !(o.isTextblock || Re(t.doc, e.pos))
            ? !1
...
function fc(t, e, n, r) {
    ...
    if (
        ...
        if (n) {
            ...
            p = v.from(o.copy(p));
            let m = t.tr.step(new se(e.pos - 1, h, e.pos, h, new E(p, 1, 0), s.length, !0)),
                g = m.doc.resolve(h + 2 * s.length);
            (g.nodeAfter && g.nodeAfter.type == o.type && Re(m.doc, g.pos) && m.join(g.pos),
                n(m.scrollIntoView()));
        }
        return !0;
    }
...
function hc(t) {
    return function (e, n) {
        ...
        return o.node(i).isTextblock
            ? (n && n(e.tr.setSelection(D.create(e.doc, t < 0 ? o.start(i) : o.end(i)))), !0)
            : !1;
    };
}
var ns = hc(-1),
...
function tm(t, e, n, r, o) {
    let i = v.empty;
    for (let d = n.length - 1; d >= 0; d--) i = v.from(n[d].type.create(n[d].attrs, i));
    t.step(new se(e.start - (r ? 2 : 0), e.end, e.start, e.end, new E(i, 0, 0), n.length, !0));
    let s = 0;
    ...
    for (let d = e.startIndex, u = e.endIndex, f = !0; d < u; d++, f = !1)
        (!f && Ee(t.doc, a, l) && (t.split(a, l), (a += 2 * l)), (a += c.child(d).nodeSize));
    return t;
}
function gc(t) {
    return function (e, n) {
        ...
        return i ? (n ? (r.node(i.depth - 1).type == t ? nm(e, n, t, i) : rm(e, n, i)) : !0) : !1;
    };
}
function nm(t, e, n, r) {
    let o = t.tr,
    ...
    i < s &&
        (o.step(
            new se(i - 1, s, i, s, new E(v.from(n.create(null, r.parent.copy())), 1, 0), 1, !0)
        ),
    ...
    return (
        Re(o.doc, a.pos) && a.nodeBefore.type == a.nodeAfter.type && o.join(a.pos),
        e(o.scrollIntoView()),
        !0
    );
}
function rm(t, e, n) {
    ...
    let l = n.startIndex == 0,
        ...
        c = i.node(-1),
        d = i.index(-1);
    if (!c.canReplace(d + (l ? 0 : 1), d + 1, s.content.append(a ? v.empty : v.from(o)))) return !1;
    let u = i.pos,
        f = u + s.nodeSize;
    return (
        r.step(
    ...
    return function (e, n) {
        ...
        if (n) {
            let c = a.lastChild && a.lastChild.type == l.type,
                ...
                u = new E(v.from(t.create(null, v.from(l.type.create(null, d)))), c ? 3 : 1, 0),
                f = i.start,
                h = i.end;
            n(e.tr.step(new se(f - (c ? 3 : 1), h, f, h, u, 1, !0)).scrollIntoView());
        }
        return !0;
    };
}
...
function lm(t, e) {
    for (;;) {
        ...
        } else if (t.parentNode && !nr(t)) ((e = fe(t) + 1), (t = t.parentNode));
        else return null;
    }
}
function am(t, e, n) {
...
var Qr = function (t) {
    return t.focusNode && Yt(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset);
};
function Ut(t, e) {
...
var ms = !ve && /Chrome\/(\d+)/.exec(It),
    ...
    um = rr ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function fm(t) {
...
function od(t, e, n) {
    let { node: r, offset: o, atom: i } = t.docView.domFromPos(e, n < 0 ? -1 : 1),
        s = rr || Pe;
    if (r.nodeType == 3)
        if (s && (Sm.test(r.nodeValue) || (n < 0 ? !o : o == r.nodeValue.length))) {
            let a = Et(pt(r, o, o), n);
...
function Tm(t, e, n) {
    return Sc == e && Cc == n
        ? vc
        : ((Sc = e), (Cc = n), (vc = n == 'up' || n == 'down' ? Cm(t, e, n) : Mm(t, e, n)));
}
var Le = 0,
    Mc = 1,
    Kt = 2,
    ...
    Qt = class {
        ...
        domFromPos(e, n) {
            ...
            for (
                let i;
                r && !(i = this.children[r - 1]).size && i instanceof _r && i.side >= 0;
                r--
            );
            if (n <= 0) {
                let i,
...
`
            ...
            if (Pe && d.focusNode && d.focusNode != a.node && d.focusNode.nodeType == 1) {
    ...
    Mn = class t extends Qt {
        ...
        static create(e, n, r, o) {
            ...
            return (
                (!s || !s.dom) &&
                    (s = ct.renderSpec(document, n.type.spec.toDOM(n, r), null, n.attrs)),
    ...
    Dt = class t extends Qt {
        ...
        matchesNode(e, n, r) {
            return (
                this.dirty == Le && e.eq(this.node) && Ur(n, this.outerDeco) && r.eq(this.innerDeco)
            );
        }
        get size() {
        ...
        localCompositionInfo(e, n) {
            ...
            if (!(e.state.selection instanceof D) || r < n || o > n + this.node.content.size)
                return null;
...
function sd(t, e, n) {
    ...
    for (let i = 0; i < e.length; i++) {
        ...
        if (s instanceof Mn) {
            ...
            (sd(s.contentDOM, s.children, n), (r = a ? a.nextSibling : t.firstChild));
        }
    }
    for (; r; ) ((r = Ac(r)), (o = !0));
    ...
    for (let i = 0; i < t.length; i++) {
        ...
        if (s) {
            ...
            for (let l in s) {
                let a = s[l];
                a != null &&
                    (n && o.length == 1 && o.push((r = new Xn(e.isInline ? 'span' : 'div'))),
                    l == 'class'
...
var ws = class {
            ...
            if (a instanceof Dt) {
                ...
                if (!f && (u = this.recreateWrapper(a, e, n, r, o, s)))
                    return (
                        ...
                        u.contentDOM &&
                            ((u.dirty = Kt), u.updateChildren(o, s + 1), (u.dirty = Le)),
                        (this.changed = !0),
                        this.index++,
                        !0
                    );
    ...
    addTextblockHacks() {
        let e = this.top.children[this.index - 1],
            n = this.top;
        for (; e instanceof Mn; ) ((n = e), (e = n.children[n.children.length - 1]));
        (!e ||
            !(e instanceof Wr) ||
            /\n$/.test(e.node.text) ||
            (this.view.requiresGeckoHackNode && /\s$/.test(e.node.text))) &&
            ((we || de) && e && e.dom.contentEditable == 'false' && this.addHackNode('IMG', n),
...
function cd(t) {
    return t.editable
        ? t.hasFocus()
        : ud(t) && document.activeElement && document.activeElement.contains(t.dom);
}
function gt(t, e = !1) {
...
function dd(t, e) {
    if (e instanceof L) {
        ...
        n != t.lastSelectedViewDesc && (Rc(t), n && n.selectNode(), (t.lastSelectedViewDesc = n));
    } else Rc(t);
}
function Rc(t) {
...
function Ds(t, e, n, r) {
    return t.someProp('createSelectionBetween', (o) => o(t, e, n)) || D.between(e, n, r);
}
function Dc(t) {
        ...
        if (n.indexOf('s') > -1) {
            ...
            if (t.endOfTextblock(e > 0 ? 'forward' : 'backward')) {
                ...
                return i.isAtom || ((s = t.docView.descAt(l)) && !s.contentDOM)
                    ? L.isSelectable(i)
                        ? Nt(t, new L(e < 0 ? t.state.doc.resolve(o.pos - i.nodeSize) : o))
                        : rr
                          ? Nt(t, new D(t.state.doc.resolve(e < 0 ? l : l + i.nodeSize)))
                          : !1
                    : !1;
            }
        } else return !1;
    else {
        if (r instanceof L && r.node.isInline) return Nt(t, new D(e > 0 ? r.$to : r.$from));
        {
            let o = ks(t.state, e);
            return o ? Nt(t, o) : !1;
        }
...
function Bm(t) {
    ...
    let o,
        i,
        s = !1;
    for (Pe && n.nodeType == 1 && r < Kr(n) && Yn(n.childNodes[r], -1) && (s = !0); ; )
        if (r > 0) {
            ...
            if (fd(n)) break;
            {
                ...
                for (; l && Yn(l, -1); ) ((o = n.parentNode), (i = fe(l)), (l = l.previousSibling));
                if (l) ((n = l), (r = Kr(n)));
                else {
...
function zm(t) {
    ...
    for (;;)
        if (r < o) {
            ...
            {
                let l = n.nextSibling;
                for (; l && Yn(l, 1); ) ((i = l.parentNode), (s = fe(l) + 1), (l = l.nextSibling));
                if (l) ((n = l), (r = 0), (o = Kr(n)));
                else {
                    if (((n = n.parentNode), n == t.dom)) break;
                    r = o = 0;
...
function Hm(t, e) {
    for (; t && e == t.childNodes.length && !nr(t); ) ((e = fe(t) + 1), (t = t.parentNode));
...
function Ss(t, e, n) {
    if (e.nodeType != 3) {
        let i, s;
        (s = Hm(e, n)) ? ((e = s), (n = 0)) : (i = $m(e, n)) && ((e = i), (n = i.nodeValue.length));
    }
...
function Lc(t, e, n) {
    let r = t.state.selection;
    if ((r instanceof D && !r.empty) || n.indexOf('s') > -1 || (De && n.indexOf('m') > -1))
        return !1;
    let { $from: o, $to: i } = r;
...
function _m(t, e) {
    ...
    if ((n == 46 && !e.shiftKey) || (De && n == 68 && r == 'c')) return Bc(t, 1) || xn(t, 1);
    if (n == 13 || n == 27) return !0;
    if (n == 37 || (De && n == 66 && r == 'c')) {
        let o = n == 37 ? (Pc(t, t.state.selection.from) == 'ltr' ? -1 : 1) : -1;
        return Ic(t, o, r) || xn(t, o);
    } else if (n == 39 || (De && n == 70 && r == 'c')) {
        let o = n == 39 ? (Pc(t, t.state.selection.from) == 'ltr' ? 1 : -1) : 1;
        return Ic(t, o, r) || xn(t, o);
    } else {
        if (n == 38 || (De && n == 80 && r == 'c')) return Lc(t, -1, r) || xn(t, -1);
        if (n == 40 || (De && n == 78 && r == 'c')) return Fm(t) || Lc(t, 1, r) || xn(t, 1);
        if (r == (De ? 'm' : 'c') && (n == 66 || n == 73 || n == 89 || n == 90)) return !0;
    }
    return !1;
}
function Is(t, e) {
...
`
    ...
    else if (((l = E.maxOpen(jm(l.content, o), !0)), l.openStart || l.openEnd)) {
        let u = 0,
            f = 0;
        for (
        ...
        if (
            (t.forEach((l) => {
                ...
                let a = o.findWrapping(l.type),
                    c;
                if (!a) return (s = null);
                if ((c = s.length && i.length && md(a, i, l, s[s.length - 1], 0)))
                    s[s.length - 1] = c;
                else {
                    s.length && (s[s.length - 1] = gd(s[s.length - 1], i.length));
                    let d = pd(l, a);
...
function Hc(t, e, n) {
    return (
        e < t.openStart &&
            (t = new E(Cs(t.content, -1, e, t.openStart, 0, t.openEnd), e, t.openEnd)),
        n < t.openEnd && (t = new E(Cs(t.content, 1, n, t.openEnd, 0, 0), t.openStart, n)),
        t
    );
}
var yd = {
    ...
    for (let e in Se) {
        ...
        t.dom.addEventListener(
            ...
            (t.input.eventHandlers[e] = (r) => {
                Qm(t, r) && !Ps(t, r) && (t.editable || !(r.type in Ce)) && n(t, r);
            }),
...
function Zm(t, e) {
    !Ps(t, e) && Se[e.type] && (t.editable || !(e.type in Ce)) && Se[e.type](t, e);
}
Ce.keydown = (t, e) => {
    let n = e;
    if (
        ...
        if (
            ...
            ((t.input.lastIOSEnter = r),
                (t.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
                    t.input.lastIOSEnter == r &&
                        (t.someProp('handleKeyDown', (o) => o(t, Ut(13, 'Enter'))),
...
Ce.keypress = (t, e) => {
    let n = e;
    if (xd(t, n) || !n.charCode || (n.ctrlKey && !n.altKey) || (De && n.metaKey)) return;
...
function tg(t, e) {
    ...
    let n = t.state.doc.resolve(e),
        r = n.nodeAfter;
    return r && r.isAtom && L.isSelectable(r) ? (Sn(t, new L(n), 'pointer'), !0) : !1;
}
function ng(t, e) {
    if (e == -1) return !1;
    let n = t.state.selection,
...
function og(t, e, n, r) {
    return (
        Ls(t, 'handleDoubleClickOn', e, n, r) || t.someProp('handleDoubleClick', (o) => o(t, e, r))
    );
}
function ig(t, e, n, r) {
    return (
...
function sg(t, e, n) {
    ...
    let r = t.state.doc;
    if (e == -1)
        return r.inlineContent ? (Sn(t, D.create(r, 0, r.content.size), 'pointer'), !0) : !1;
    let o = r.resolve(e);
    for (let i = o.depth + 1; i > 0; i--) {
        let s = i > o.depth ? o.nodeAfter : o.node(i),
            l = o.before(i);
        if (s.inlineContent) Sn(t, D.create(r, l + 1, l + 1 + s.content.size), 'pointer');
...
var Ts = class {
    constructor(e, n, r, o) {
        ...
        (((r.button == 0 && i.type.spec.draggable && i.type.spec.selectable !== !1) ||
    ...
    up(e) {
        ...
        let n = this.pos;
        (this.view.state.doc != this.startDoc && (n = this.view.posAtCoords(Zr(e))),
            ...
            this.allowDefault || !n
                ...
                : rg(this.view, n.pos, n.inside, e, this.selectNode)
                  ...
                  : e.button == 0 &&
                      (this.flushed ||
                          (we && this.mightDrag && !this.mightDrag.node.isAtom) ||
                          (de &&
                    ...
                    ? (Sn(this.view, I.near(this.view.state.doc.resolve(n.pos)), 'pointer'),
                      e.preventDefault())
                    : Ot(this.view, 'pointer'));
    }
    move(e) {
...
Ce.compositionstart = Ce.compositionupdate = (t) => {
    if (!t.composing) {
        ...
        if (
            ...
            Pe && e.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length)
        ) {
            let r = t.domSelectionRange();
...
function Sd(t) {
    for (
        t.composing && ((t.input.composing = !1), (t.input.compositionEndedAt = dg()));
...
function qr(t, e = !1) {
    if (!(mt && t.domObserver.flushingSoon >= 0)) {
        if ((t.domObserver.forceFlush(), Sd(t), e || (t.docView && t.docView.dirty))) {
            let n = Rs(t),
                r = t.state.selection;
            return (
                n && !n.eq(r)
...
function hg(t, e) {
    ...
    setTimeout(() => {
        (t.focus(),
            ...
            n ? Zn(t, r.value, null, o, e) : Zn(t, r.textContent, r.innerHTML, o, e));
    }, 50);
}
...
Ce.paste = (t, e) => {
    ...
    r && Zn(t, Cd(r), r.getData('text/html'), o, n) ? n.preventDefault() : hg(t, n);
};
var Jr = class {
        constructor(e, n, r) {
...
Se.dragstart = (t, e) => {
    ...
    ((!n.dataTransfer.files.length || !de || Qc > 120) && n.dataTransfer.clearData(),
...
function mg(t, e, n) {
    ...
    i
        ...
        : (i = hd(t, Cd(e.dataTransfer), Qn ? null : e.dataTransfer.getData('text/html'), !1, o));
    let s = !!(n && vd(t, e));
...
var Gr = class t {
    ...
    Jt = class t {
        ...
        eq(e) {
            return (
                this == e || (e instanceof t && er(this.attrs, e.attrs) && er(this.spec, e.spec))
            );
        }
        static is(e) {
    ...
    As = class t {
        ...
        map(e, n, r, o) {
            ...
            return s.deleted || s.pos <= i.pos ? null : new te(i.pos - r, s.pos - r, this);
        }
        valid(e, n) {
    ...
    Y = class t {
        ...
        map(e, n, r) {
            return this == be || e.maps.length == 0 ? this : this.mapInner(e, n, 0, 0, r || Gt);
        }
        mapInner(e, n, r, o, i) {
            let s;
        ...
        add(e, n) {
            return n.length ? (this == be ? t.create(e, n) : this.addInner(e, n, 0)) : this;
        }
        addInner(e, n, r) {
            let o,
                i = 0;
            ...
            return new t(s.length ? this.local.concat(s).sort(Xt) : this.local, o || this.children);
        }
        remove(e) {
...
var bg = {
    ...
    Ns = class {
        ...
        start() {
            (this.observer &&
                (this.observer.takeRecords(), this.observer.observe(this.view.dom, bg)),
                this.onCharData &&
        ...
        flush() {
            ...
            if (Pe && a.length) {
                ...
                if (d.length == 2) {
                    ...
                    for (let f of d) {
                        let h = f.parentNode;
                        h && h.nodeName == 'LI' && (!u || Sg(e, u) != h) && f.remove();
                    }
                }
            } else if (
                (de || we) &&
        ...
        registerMutation(e, n) {
            ...
            if (e.type == 'childList') {
                ...
                let s = o && o.parentNode == e.target ? fe(o) + 1 : 0,
                    ...
                    a = i && i.parentNode == e.target ? fe(i) : e.target.childNodes.length,
...
function Tg(t, e, n, r, o) {
    ...
    let b = p.start,
        C = p.endA,
        x = (k) => {
            let O = k || t.state.tr.replace(b, C, c.doc.slice(p.start - c.from, p.endB - c.from));
            if (c.sel) {
    ...
    if (w)
        if (m.pos == g.pos) {
            ve &&
                Rt <= 11 &&
                m.parentOffset == 0 &&
                (t.domObserver.suppressSelectionUpdates(), setTimeout(() => gt(t), 20));
            ...
            let k = x(t.state.tr);
            (S.type == 'add' ? k.addMark(b, C, S.mark) : k.removeMark(b, C, S.mark), t.dispatch(k));
        } else if (
            ...
            t.someProp('handleTextInput', (T) => T(t, b, C, k, O)) || t.dispatch(O());
        } else t.dispatch(x());
    else t.dispatch(x());
}
function jc(t, e, n) {
...
function Ng(t, e, n, r, o) {
    ...
    if (s < i && t.size < e.size) {
        let a = r <= i && r >= s ? i - r : 0;
        ((i -= a),
            i && i < e.size && Uc(e.textBetween(i - 1, i + 1)) && (i += a ? 1 : -1),
            (l = i + (l - s)),
            (s = i));
    } else if (l < i) {
        let a = r <= i && r >= l ? i - r : 0;
        ((i -= a),
            i && i < t.size && Uc(t.textBetween(i - 1, i + 1)) && (i += a ? 1 : -1),
            (s = i + (s - l)),
            (l = i));
    }
...
var tr = class {
    constructor(e, n) {
        ((this._root = null),
            ...
            (this.docView = Tc(this.state.doc, Kc(this), ds(this), this.dom, this)),
            (this.domObserver = new Ns(this, (r, o, i, s) => Tg(this, r, o, i, s))),
    ...
    update(e) {
        ...
        let n = this._props;
        ((this._props = e),
            e.plugins && (e.plugins.forEach(Xc), (this.directPlugins = e.plugins)),
    ...
    updateStateInner(e, n) {
        ...
        let o = this.state,
            i = !1,
            s = !1;
        (e.storedMarks && this.composing && (Sd(this), (s = !0)), (this.state = e));
        ...
        let f = d == 'preserve' && s && this.dom.style.overflowAnchor == null && pm(this);
        if (s) {
    ...
    scrollToSelection() {
        ...
        if (!(!e || !this.dom.contains(e.nodeType == 1 ? e : e.parentNode))) {
            if (!this.someProp('handleScrollToSelection', (n) => n(this)))
                ...
                } else xc(this, this.coordsAtPos(this.state.selection.head, 1), e);
        }
    }
    destroyPluginViews() {
        let e;
    ...
    updateDraggedNode(e, n) {
        ...
        this.dragging = new Jr(e.slice, e.move, o < 0 ? void 0 : L.create(this.state.doc, o));
    }
    someProp(e, n) {
...
function qc(t) {
    if (t.markCursor) {
        ...
        ((e.className = 'ProseMirror-separator'),
            ...
            (t.cursorWrapper = {
                dom: e,
                deco: te.widget(t.state.selection.from, e, { raw: !0, marks: t.markCursor }),
            }));
...
var le;
for (le = 65; le <= 90; le++)
    ((yt[le] = String.fromCharCode(le + 32)), (to[le] = String.fromCharCode(le)));
var le;
...
function Ed(t) {
    var e =
            ...
            t.key == 'Unidentified',
        n = (!e && t.key) || (t.shiftKey ? to : yt)[t.keyCode] || t.key || 'Unidentified';
    return (
        n == 'Esc' && (n = 'Escape'),
        n == 'Del' && (n = 'Delete'),
        n == 'Left' && (n = 'ArrowLeft'),
...
var Pg = typeof navigator < 'u' && /Mac|iP(hone|[oa]d)/.test(navigator.platform),
...
function lo(t, e, n = { strict: !0 }) {
    let r = Object.keys(e);
    return r.length
        ? r.every((o) => (n.strict ? e[o] === t[o] : Us(e[o]) ? e[o].test(t[o]) : e[o] === t[o]))
        : !0;
}
function $d(t, e, n = {}) {
    return t.find(
        (r) => r.type === e && lo(Object.fromEntries(Object.keys(n).map((o) => [o, r.attrs[o]])), n)
    );
}
function Od(t, e, n = {}) {
    return !!$d(t, e, n);
        ...
        ({ tr: r, dispatch: o, editor: i }) => {
            ...
            if (o) {
                ...
                if (
                    ...
                    try {
                        ir(e, i.schema, { parseOptions: c, errorOnInvalidContent: !0 });
                    } catch (g) {
                        a(g);
                    }
                try {
                ...
                if (f) {
                    ...
                    let g = r.doc.resolve(d),
                        ...
                        C = y.content.size > 0;
                    (w && b && C && (d = Math.max(0, d - 1)), r.replaceWith(d, u, m));
                }
...
var xy =
        ...
        ({ tr: n, state: r, dispatch: o }) => {
            ...
            if (!l) return !1;
            (l === 'node' && (i = ne(t, r.schema)), l === 'mark' && (s = wt(t, r.schema)));
            let a = !1;
            return (
                n.selection.ranges.forEach((c) => {
                    r.doc.nodesBetween(c.$from.pos, c.$to.pos, (d, u) => {
                        (i &&
                            i === d.type &&
                            ((a = !0), o && n.setNodeMarkup(u, void 0, Rd(d.attrs, e))),
                            s &&
                                d.marks.length &&
                                d.marks.forEach((f) => {
                                    s === f.type &&
                                        ((a = !0),
                                        o &&
                                            n.addMark(u, u + d.nodeSize, s.create(Rd(f.attrs, e))));
                                }));
                    });
                }),
                a
    ...
    Ay =
        ...
        ({ state: t, dispatch: e }) =>
            ns(t, e);
function _s(t, e, n = {}, r = {}) {
    return ir(t, e, { slice: !1, parseOptions: n, errorOnInvalidContent: r.errorOnInvalidContent });
}
var Ey =
...
function B(t, e, n) {
    return t.config[e] === void 0 && t.parent
        ...
        : typeof t.config[e] == 'function'
          ? t.config[e].bind({ ...n, parent: t.parent ? B(t.parent, e, n) : null })
          : t.config[e];
}
function Xs(t) {
    return t
...
function Id(t) {
    return Object.fromEntries(
        Object.entries(t).filter(([e, n]) => (e === 'attrs' && Ny(n) ? !1 : n != null))
    );
}
function Pd(t) {
    var e, n;
    ...
    let r = Kd(t),
        ...
        a = Object.fromEntries(
            i.map((c) => {
                ...
                let m = B(c, 'renderHTML', u);
                return (
                    m && (h.toDOM = (g) => m({ mark: g, HTMLAttributes: ao(g, d) })),
                    [c.name, h]
                );
            })
        );
        ...
        (o.forEach(({ $from: u, $to: f }) => {
            ...
            t.doc.nodesBetween(h, p, (m, g) => {
                ...
                let y = Math.max(h, g),
                    ...
                    b = w - y;
                ((s += b), l.push(...m.marks.map((C) => ({ mark: C, from: y, to: w }))));
            });
        }),
        s === 0)
    )
...
function lr(t, { checkChildren: e = !0, ignoreWhitespace: n = !1 } = {}) {
    ...
    if (e) {
        ...
        return (
            t.content.forEach((i) => {
                o !== !1 && (lr(i, { ignoreWhitespace: n, checkChildren: e }) || (o = !1));
            }),
            o
        );
    }
...
var Jy =
        ...
        ({ tr: e, state: n, dispatch: r, editor: o }) => {
            ...
            let u = a.parentOffset === a.parent.content.size,
                f = l.depth === 0 ? void 0 : sr(l.node(-1).contentMatchAt(l.indexAfter(-1))),
                h = u && f ? [{ type: f, attrs: d }] : void 0,
                p = Ee(e.doc, e.mapping.map(l.pos), 1, h);
            if (
                (!h &&
                    !p &&
                    Ee(e.doc, e.mapping.map(l.pos), 1, f ? [{ type: f }] : void 0) &&
                ...
                (t && zd(n, o.extensionManager.splittableMarks), e.scrollIntoView());
            }
            return p;
        },
    Gy =
                    ...
                    let b =
                            a.indexAfter(-1) < a.node(-2).childCount
                                ...
                                : a.indexAfter(-2) < a.node(-3).childCount
                                  ? 2
                                  : 3,
                        C = { ...so(f, a.node().type.name, a.node().attrs), ...e },
                        x =
    ...
    Xy =
        ...
        ({ editor: o, tr: i, state: s, dispatch: l, chain: a, commands: c, can: d }) => {
            ...
            if (b.depth >= 1 && x && b.depth - x.depth <= 1) {
                ...
                if (Bd(x.node.type.name, u) && h.validContent(x.node.content) && l)
                    return a()
    ...
    Yy =
        ...
        ({ state: r, commands: o }) => {
            let { extendEmptyMarkRange: i = !1 } = n,
                s = wt(t, r.schema);
            return Ws(r, s, e) ? o.unsetMark(s, { extendEmptyMarkRange: i }) : o.setMark(s, e);
        },
    Qy =
        (t, e, n = {}) =>
        ({ state: r, commands: o }) => {
                                  ...
                                  y >= d &&
                                      ...
                                      s &&
                                          ...
                                          g.marks.forEach((w) => {
                                              if (s === w.type && ((a = !0), o)) {
                                                  let b = Math.max(y, d),
                                                      C = Math.min(y + g.nodeSize, u);
                                                  n.addMark(b, C, s.create({ ...w.attrs, ...e }));
                                              }
                                          })));
                          }),
                        h &&
    ...
    return (
        s.forEach((f) => {
            ...
            let p = a.state.tr,
                ...
                { commands: y, chain: w, can: b } = new uo({ editor: n, state: m });
        ...
        r = new P({
                ...
                apply(o, i, s) {
                    ...
                    return (
                        !!a &&
                            setTimeout(() => {
                                let { text: d } = a;
                                typeof d == 'string' ? (d = d) : (d = Ys(v.from(d), s.schema));
                                let { from: u } = a,
                                    f = u + d.length;
                                ro({ editor: e, from: u, to: f, text: d, rules: n, plugin: r });
                            }),
            ...
            props: {
                handleTextInput(o, i, s, l) {
                    return ro({ editor: e, from: i, to: s, text: l, rules: n, plugin: r });
                },
                handleDOMEvents: {
                    compositionend: (o) => (
                        setTimeout(() => {
...
var nl = class {
        ...
        get storage() {
            return {
                ...(G(B(this, 'addStorage', { name: this.name, options: this.options })) || {}),
            };
        }
        configure(t = {}) {
            let e = this.extend({ ...this.config, addOptions: () => nu(this.options, t) });
    ...
    return (
        n.doc.nodesBetween(r, o, (h, p) => {
            ...
            let C =
                ...
                S = Math.min(o, p + C);
            if (x >= S) return;
            let k = h.isText ? h.text || '' : h.textBetween(x - p, S - p, void 0, '\uFFFC');
        ...
        (d) =>
            new P({
                ...
                appendTransaction: (u, f, h) => {
                    ...
                    if (w) {
                        let { text: x } = y;
                        typeof x == 'string' ? (x = x) : (x = Ys(v.from(x), h.schema));
                        let { from: S } = y,
                            k = S + x.length,
                            O = mb(x);
                        return a({ rule: d, state: h, from: S, to: { b: k }, pasteEvt: O });
                    }
                    let b = f.doc.content.findDiffStart(h.doc.content),
                        C = f.doc.content.findDiffEnd(h.doc.content);
                    if (!(!ub(b) || !C || b === C.b))
                        return a({ rule: d, state: h, from: b, to: C, pasteEvt: s });
                },
            })
    );
}
                ...
                new P({
                    ...
                    appendTransaction: (t, e, n) => {
                        ...
                        let f = n.tr,
                            ...
                            { commands: p } = new uo({ editor: this.editor, state: h });
...
var gu = class extends lb {
    constructor(t = {}) {
        (super(),
            ...
            (this.utils = { getUpdatedPosition: Hy, createMappablePosition: $y }),
            this.setOptions(t),
    ...
    registerPlugin(t, e) {
        let n = Ud(e) ? e(t, [...this.state.plugins]) : [...this.state.plugins, t],
    ...
    createDoc() {
        let t;
        try {
            t = _s(this.options.content, this.schema, this.options.parseOptions, {
                ...
                for (k.lastIndex = 0; ; ) {
                    ...
                    if (!((p = T[2]) != null && p.endsWith(':::'))) {
                        if ($) C += 1;
                                        ...
                                        V = h.blockTokens(z),
                                            V.forEach((N) => {
                                                N.text &&
                                                    ...
                                                    (N.tokens = h.inlineTokens(N.text));
                                            });
                                        V.length > 0;
                                    ) {
                                        let N = V[V.length - 1];
                            ...
                            return { type: e, raw: K, attributes: b, content: S, tokens: V };
                        }
                    }
                }
            },
...
`;
        ...
        for (d += 1; d < l.length; ) {
            ...
            if (x.trim() === '') {
                ...
                if (k === -1) break;
                if (
                    (((o = (r = l[d + 1 + k].match(/^(\s*)/)) == null ? void 0 : r[1]) == null
                        ? void 0
                        : o.length) || 0) > m
                ) {
                    (y.push(x),
...
`);
            x.trim() &&
                (e.customNestedParser ? (w = e.customNestedParser(x)) : (w = n.blockTokens(x)));
        }
...
function Eb(t) {
    for (let e = t.depth; e >= 0; e--) {
        ...
        for (let o = r.child(n - 1); ; o = o.lastChild) {
            if ((o.childCount == 0 && !o.inlineContent) || Su(o.type)) return !0;
...
function Db(t, e) {
    if (e.inputType != 'insertCompositionText' || !(t.state.selection instanceof ae)) return !1;
    let { $from: n } = t.state.selection,
        r = n.parent.contentMatchAt(n.index()).findWrapping(t.state.schema.nodes.text);
    if (!r) return !1;
    let o = v.empty;
    for (let s = r.length - 1; s >= 0; s--) o = v.from(r[s].createAndFill(null, o));
    let i = t.state.tr.replace(n.pos, n.pos, new E(o, 0, 0));
    return (i.setSelection(D.near(i.doc.resolve(n.pos + 1))), t.dispatch(i), !1);
}
function Ib(t) {
...
he.prototype.slice = function (e, n) {
    return (
        ...
        e >= n ? he.empty : this.sliceInner(Math.max(0, e), Math.min(this.length, n))
    );
};
...
var vu = (function (t) {
    ...
    return (
        ...
        (e.prototype.leafAppend = function (o) {
            if (this.length + o.length <= ko) return new e(this.values.concat(o.flatten()));
        }),
        (e.prototype.leafPrepend = function (o) {
            if (this.length + o.length <= ko) return new e(o.flatten().concat(this.values));
        }),
    ...
    tn = class t {
        ...
        addMaps(e) {
            return this.eventCount == 0
                ? this
                : new t(this.items.append(e.map((n) => new nt(n))), this.eventCount);
        }
        rebased(e, n) {
            ...
            let d = this.items.slice(0, o).append(c).append(r),
                u = new t(d, l);
            return (u.emptyItemCount() > Lb && (u = u.compress(this.items.length - r.length)), u);
        }
        emptyItemCount() {
            let e = 0;
            return (
    ...
    if (n.getMeta('addToHistory') !== !1 && !(s && s.getMeta('addToHistory') === !1)) {
        let l = n.getMeta('composition'),
            a =
                ...
                (!s &&
                    t.prevComposition != l &&
                    (t.prevTime < (n.time || 0) - r.newGroupDelay || !$b(n, t.prevRanges))),
            c = s ? al(t.prevRanges, n.mapping) : Mu(n.mapping.maps);
        return new rt(
            t.done.addTransform(n, a ? e.selection.getBookmark() : void 0, r, So(e)),
            tn.empty,
            c,
            n.time,
            l ?? t.prevComposition
...
function Fb(t, e, n) {
    ...
    return i.transform.setSelection(s).setMeta(en, { redo: n, historyState: a });
}
var cl = !1,
    Tu = null;
function So(t) {
        ...
        new P({
            ...
            props: {
                handleDOMEvents: {
                    beforeinput(e, n) {
                        let r = n.inputType,
                            o = r == 'historyUndo' ? dl : r == 'historyRedo' ? ul : null;
                        return !o || !e.editable
                            ? !1
...
var C1 = U.create({
    ...
    Ou = U.create({
        ...
        extendNodeSchema(t) {
            ...
            return { allowGapCursor: (e = G(B(t, 'allowGapCursor', n))) != null ? e : null };
        },
    }),
    fl = U.create({
        name: 'placeholder',
...
var jb = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/,
    ...
    Jb = ee.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return Nn('strong', { ...R(this.options.HTMLAttributes, t), children: Nn('slot', {}) });
        },
        ...
        addInputRules() {
            return [Be({ find: jb, type: this.type }), Be({ find: Kb, type: this.type })];
        },
        addPasteRules() {
            return [Me({ find: Ub, type: this.type }), Me({ find: qb, type: this.type })];
        },
    }),
    Iu = Jb;
var Gb = /(^|[^`])`([^`]+)`(?!`)$/,
...
`),
                                ...
                                if (b === 0) return !0;
                                let C = d;
                                for (let S = 0; S < p; S += 1) C += h[S].length + 1;
                                return (
                                    l.delete(C, C + b),
                                    c - C <= b && l.setSelection(D.create(l.doc, C)),
                                    !0
                                );
                            })
                          : t.commands.command(({ tr: l }) => {
...
`);
        ...
        addInputRules() {
            return [
                ar({ find: Qb, type: this.type, getAttributes: (t) => ({ language: t[1] }) }),
                ar({ find: Zb, type: this.type, getAttributes: (t) => ({ language: t[1] }) }),
            ];
        },
        addProseMirrorPlugins() {
            return [
...
`
                            ...
                            return (
                                ...
                                s.selection.$from.parent.type !== this.type &&
                                    s.setSelection(
                                        D.near(s.doc.resolve(Math.max(0, s.selection.from - 2)))
                                    ),
                                s.setMeta('paste', !0),
                                t.dispatch(s),
                                !0
            ...
            return {
                ...
                unsetDetails:
                    ...
                    ({ state: t, chain: e }) => {
                        ...
                        if (!o) return !1;
                        let i = En(o.node, (y) => y.type === r.nodes.detailsSummary),
                            s = En(o.node, (y) => y.type === r.nodes.detailsContent);
            ...
            return [
                new P({
                    ...
                    appendTransaction: (t, e, n) => {
                        ...
                        if (!d) return;
                        let u = En(d.node, (y) => y.type === n.schema.nodes.detailsSummary);
                        if (!u.length) return;
                        let f = u[0],
                            p =
                                    ...
                                    if (l) {
                                        ...
                                        if (a.nodeAfter)
                                            a.nodeAfter.isTextblock
                                                ? s.setSelection(D.create(s.doc, a.pos + 1))
                                                : a.nodeAfter.isBlock
                                            ...
                                            u &&
                                                (s.insert(c, u),
                                                s.setSelection(D.create(s.doc, c + 1)));
                                        }
                                        s.scrollIntoView();
                                    }
                                    return !0;
...
var c0 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/,
    ...
    h0 = ee.create({
        ...
        addInputRules() {
            return [Be({ find: c0, type: this.type }), Be({ find: u0, type: this.type })];
        },
        addPasteRules() {
            return [Me({ find: d0, type: this.type }), Me({ find: f0, type: this.type })];
        },
    }),
    Ju = h0;
var p0 = /(?:^|\s)(!\[(.+|:?)]\((\S+)(?:(?:\s+)["'](\S+)["'])?\))$/,
...
function v0(t = []) {
    ...
    (re(l, xt), re(l, kt, i), re(l, dr, l), re(i, kt, i), re(i, xt), re(i, dr, i));
...
function Pt(t, e, n, r, o) {
    ...
    for (let l = 0; l < s - 1; l++) {
        let a = e[l];
        (t.j[a] ? (i = t.j[a]) : ((i = new Te(r)), (i.jr = o.slice()), (t.j[a] = i)), (t = i));
    }
...
Pl.prototype = {
    ...
    get(t, e, n) {
        ...
        return (
            o &&
            (typeof o == 'object'
                ? ((o = n.t in o ? o[n.t] : wr[t]), typeof o == 'function' && r && (o = o(e, n)))
...
function A0({ groups: t }) {
    let e = t.domain.concat([
        ...
        r = [Wo, jo, Uo, Ko, qo, Jo, Go, Xo, He, hr, pr, mr, Yo, Qo, Zo, gr, it, ti, yr, ei],
        o = ze(),
        i = M(o, yr);
    ...
    let p = M(u, He);
    (M(p, He, p), j(p, t.domain, u), j(h, t.domain, u), M(h, ot, f), M(h, He, p));
    let m = M(h, Bt);
    j(m, t.numeric, nf);
    let g = M(s, He),
        y = M(s, ot);
    ...
    for (let z = 0; z < $.length; z++) {
        ...
        j(N, e, _);
        let W = ze();
        (j(N, n), j(_, e, _), j(_, n, W), j(W, e, _), j(W, n, W), M(_, V, x), M(W, V, x));
    }
...
function E0(t, e, n) {
    ...
    for (; o < r; ) {
        ...
        if (f < 0) ((o -= d), o < r && (s.push(n[o]), o++));
            ...
            (s.length > 0 && (i.push(wl(rf, e, s)), (s = [])), (o -= f), (d -= f));
            let h = u.t,
                p = n.slice(o - d, o);
            i.push(wl(h, e, p));
        }
...
function Ll(t, e = !1) {
    if (
        (Z.initialized &&
            N0(`linkifyjs: already initialized - will not register custom scheme "${t}" ${O0}`),
...
function R0() {
    ...
    for (let t = 0; t < Z.tokenQueue.length; t++) Z.tokenQueue[t][1]({ scanner: Z.scanner });
...
function ri(t) {
    return (Z.initialized || R0(), E0(Z.parser.start, t, uf(Z.scanner.start, t)));
}
ri.scan = uf;
                ...
                (el(l).forEach(({ newRange: c }) => {
                    ...
                    if (u && f) {
                        ...
                        g.filter((y) => y.isLink)
                            ...
                            .forEach((y) => {
                                po(y.from, y.to, r.doc).some((w) => w.mark.type === t.type) ||
    ...
    return new P({
        ...
        props: {
            handleClick: (e, n, r) => {
                ...
                let s = !1;
                if (
                    (t.enableClickSelection && (s = t.editor.commands.extendMarkRange(t.type.name)),
                    t.openOnClick)
                ) {
                    let l = null;
                    ...
                    getAttrs: (t) => {
                        ...
                        return !e ||
                            !this.options.isAllowedUri(e, {
                                defaultValidate: (n) => !!rn(n, this.options.protocols),
                    ...
                    ({ commands: t, chain: e }) =>
                        this.options.keepAttributes
                            ? e()
                                  ...
                                  .updateAttributes(_0, this.editor.getAttributes(mf))
                                  .run()
                            : t.toggleList(
                                  this.name,
                                  this.options.itemTypeName,
    ...
    Fl = F.create({
        ...
        parseMarkdown: (t, e) => {
            ...
            if (t.tokens && t.tokens.length > 0)
                if (t.tokens.some((o) => o.type === 'paragraph')) n = e.parseChildren(t.tokens);
                else {
                    let o = t.tokens[0];
                ...
                Delete: ({ editor: t }) => {
                    ...
                    return (
                        this.options.listTypes.forEach(({ itemName: n }) => {
                            t.state.schema.nodes[n] !== void 0 && Hl(t, n) && (e = !0);
                        }),
                        e
                    );
                },
                ...
                Backspace: ({ editor: t }) => {
                    ...
                    return (
                        this.options.listTypes.forEach(({ itemName: n, wrapperNames: r }) => {
                            t.state.schema.nodes[n] !== void 0 && zl(t, n, r) && (e = !0);
                        }),
                        e
                    );
                },
                    ...
                    ({ commands: t, chain: e }) =>
                        this.options.keepAttributes
                            ? e()
                                  ...
                                  .updateAttributes(G0, this.editor.getAttributes(bf))
                                  .run()
                            : t.toggleList(
                                  this.name,
                                  this.options.itemTypeName,
            ...
            return (
                (this.options.keepMarks || this.options.keepAttributes) &&
                    (t = tt({
                        ...
                        keepMarks: this.options.keepMarks,
                        keepAttributes: this.options.keepAttributes,
                        getAttributes: (e) => ({ start: +e[1], ...this.editor.getAttributes(bf) }),
                        joinPredicate: (e, n) => n.childCount + n.attrs.start === +e[1],
                        editor: this.editor,
                    })),
                [t]
            ...
            return ({ node: t, HTMLAttributes: e, getPos: n, editor: r }) => {
                let o = document.createElement('li'),
                    ...
                    c = (d) => {
                        var u, f;
                        l.ariaLabel =
                            ((f = (u = this.options.a11y) == null ? void 0 : u.checkboxLabel) ==
                            null
                                ? void 0
                        ...
                        (r.isEditable &&
                            ...
                            r
                                ...
                                .command(({ tr: f }) => {
                                    ...
                                    return (
                                        f.setNodeMarkup(h, void 0, { ...p?.attrs, checked: u }),
                                        !0
                                    );
                                })
                                .run(),
...
`
    ...
    dv = U.create({
        ...
        addExtensions() {
            let t = [];
            return (
                this.options.bulletList !== !1 && t.push($l.configure(this.options.bulletList)),
                this.options.listItem !== !1 && t.push(Fl.configure(this.options.listItem)),
                this.options.listKeymap !== !1 && t.push(U0.configure(this.options.listKeymap)),
                this.options.orderedList !== !1 && t.push(_l.configure(this.options.orderedList)),
                this.options.taskItem !== !1 && t.push(Y0.configure(this.options.taskItem)),
                this.options.taskList !== !1 && t.push(Q0.configure(this.options.taskList)),
                t
            );
        },
    });
    ...
    Z0 = ({
        ...
        return new P({
            ...
            props: {
                handleDrop(d, u) {
                    ...
                    return (
                        f.forEach((m, g) => {
                            ...
                            let y = ('10000000-1000-4000-8000' + -1e11).replace(/[018]/g, (w) =>
                                (
                                    w ^
                                    (crypto.getRandomValues(new Uint8Array(1))[0] & (15 >> (w / 4)))
                                ).toString(16)
                            );
                            r().upload(`componentFileAttachments.${l}.${y}`, m, () => {
                                c(y).then((w) => {
                                    w &&
                                        ...
                                        g === f.length - 1 && ii(d, 'form-processing-finished'));
                                });
                            });
                        }),
                        !0
                ...
                handlePaste(d, u) {
                    if (!u.clipboardData?.files.length || u.clipboardData?.getData('text').length)
                        return !1;
                        ...
                        : f.length
                          ? (u.preventDefault(),
                            ...
                            f.forEach((p, m) => {
                                ...
                                let g = ('10000000-1000-4000-8000' + -1e11).replace(/[018]/g, (y) =>
                                    (
                                        y ^
...
function ew(t) {
    ...
    return (
        ...
        b < l.pos && C >= l.pos
            ? { range: { from: b, to: C }, query: g[0].slice(n.length), text: g[0] }
            : null
    );
}
...
function nw({
            ...
            k
                ? () => {
                      let O = t.getState(e.state),
                          T = O?.decorationId,
                          A = S.dom.querySelector(`[data-decoration-id="${T}"]`);
    ...
    function C(S, k) {
        ...
        try {
            let A = t.getState(S.state),
                $ = A?.decorationId
                    ? S.dom.querySelector(`[data-decoration-id="${A.decorationId}"]`)
                    : null,
                z = {
                    editor: e,
                    ...
                    items: [],
                    command: (K) =>
                        u({ editor: e, range: A?.range || { from: 0, to: 0 }, props: K }),
                    decorationNode: $,
                    clientRect: b(S, $),
                };
    ...
    let x = new P({
            ...
            return {
                update: async (S, k) => {
                    ...
                    let N = (O = this.key) == null ? void 0 : O.getState(k),
                        _ = (T = this.key) == null ? void 0 : T.getState(S.state),
                        W = N.active && _.active && N.range.from !== _.range.from,
                        Q = !N.active && _.active,
                    ...
                    if (!q && !We && !je) return;
                    let dn = je && !q ? N : _,
                        aa = S.dom.querySelector(`[data-decoration-id="${dn.decorationId}"]`);
                    ((g = {
                        editor: e,
                        range: dn.range,
                        query: dn.query,
                        text: dn.text,
                        items: [],
                        command: (ip) => u({ editor: e, range: dn.range, props: ip }),
                        decorationNode: aa,
                        clientRect: b(S, aa),
                    }),
                        q && ((A = y?.onBeforeStart) == null || A.call(y, g)),
                        We && (($ = y?.onBeforeUpdate) == null || $.call(y, g)),
                        (We || q) && (g.items = await f({ editor: e, query: dn.query })),
        ...
        state: {
            ...
            apply(S, k, O, T) {
                ...
                if (((N.composing = $), A && (K || e.view.composing))) {
                    (V < k.range.from || V > k.range.to) && !$ && !k.composing && (N.active = !1);
                    let W = m({
                            char: n,
                            allowSpaces: r,
                            allowToIncludeChar: o,
                    ...
                    W && p({ editor: e, state: T, range: W.range, isActive: k.active })
                        ? ((N.active = !0),
                          (N.decorationId = k.decorationId ? k.decorationId : Q),
                          (N.range = W.range),
                          (N.query = W.query),
                          (N.text = W.text))
                        : (N.active = !1);
        ...
        props: {
                ...
                if (k.key === 'Escape' || k.key === 'Esc') {
                    let N = x.getState(S.state),
                        ...
                        W =
                            _ ??
                            (N?.decorationId
                                ? S.dom.querySelector(`[data-decoration-id="${N.decorationId}"]`)
                                : null);
                    if (
                        ((T = y?.onKeyDown) == null
                            ? void 0
                            : T.call(y, { view: S, event: k, range: N.range })) ||
                        !1
                    )
                        return !0;
                    let me = {
                        ...
                        text: N.text,
                        items: [],
                        command: (Ge) => u({ editor: e, range: N.range, props: Ge }),
                        decorationNode: W,
                        clientRect: W ? () => W.getBoundingClientRect() || null : null,
                    };
                    return ((A = y?.onExit) == null || A.call(y, me), C(S, t), !0);
                }
                return (
                    (($ = y?.onKeyDown) == null
                        ? void 0
            ...
            decorations(S) {
                let { active: k, range: O, decorationId: T, query: A } = x.getState(S);
                if (!k) return null;
                let $ = !A?.length,
                    z = [a];
                return (
...
var si = nw;
var rw = function ({ editor: t, overrideSuggestionOptions: e, extensionName: n }) {
        let r = new H();
        return {
            editor: t,
            char: '{{',
    ...
    Ef = F.create({
        ...
        renderHTML({ node: t, HTMLAttributes: e }) {
            ...
            return typeof o == 'string'
                ? ['span', R({ 'data-type': this.name }, this.options.HTMLAttributes, e), o]
                : o;
        },
        renderText({ node: t }) {
            let e = {
        ...
        onBeforeCreate() {
            ((this.storage.suggestions = (
                ...
                rw({ editor: this.editor, overrideSuggestionOptions: t, extensionName: this.name })
            )),
...
function If(t, e, n, r) {
    let o = Fe(t),
        i = cw(Ne(t), n === 'start', r);
    return (o && ((i = i.map((s) => s + '-' + o)), e && (i = i.concat(i.map(kr)))), i);
}
function Sr(t) {
...
function di(t) {
    return typeof t != 'number' ? dw(t) : { top: t, right: t, bottom: t, left: t };
}
function Ct(t) {
...
var Hf = (t) => ({
    ...
    async fn(e) {
        ...
        return {
            [h]: f[h] + W,
            data: { [h]: N, centerOffset: V - N - W, ...(_ && { alignmentOffset: W }) },
            reset: _,
        };
    },
});
            ...
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    ...
                    let { rects: i, middlewareData: s, placement: l, platform: a, elements: c } = e,
                        ...
                        w = m[y];
                    if (w == null) return {};
                    let b = Kl(w, i, await (a.isRTL == null ? void 0 : a.isRTL(c.floating)));
                    ...
                    let C = [g[Ne(w)], g[b[0]], g[b[1]]],
                        ...
                        S = m[y + 1];
                    if (S) return { data: { index: y + 1, overflows: x }, reset: { placement: S } };
                    let k = x
                            .map((A) => {
                                let $ = Fe(A.placement);
                                return [
                                    A.placement,
                                    $ && d
                                        ? A.overflows.slice(0, 2).reduce((z, K) => z + K, 0)
                                        : A.overflows[0],
                                    A.overflows,
                                ];
                            })
                        ...
                        T =
                            ((o = k.filter((A) =>
                                ...
                                : o[0]) || k[0][0];
                    return T !== l
                        ? { data: { index: y + 1, overflows: x }, reset: { placement: T } }
                        : {};
                },
            }
        );
        ...
        return (
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    ...
                    if (((A = [...A, { placement: o, overflows: T }]), !T.every((V) => V <= 0))) {
                        var $, z;
                        let V = ((($ = i.flip) == null ? void 0 : $.index) || 0) + 1,
                            N = k[V];
                        if (
                            N &&
                            (!(u === 'alignment' ? w !== Ke(N) : !1) ||
                                A.every((Q) => (Ke(Q.placement) === w ? Q.overflows[0] > 0 : !0)))
                        )
                            return { data: { index: V, overflows: A }, reset: { placement: N } };
                        let _ =
            ...
            async fn(e) {
                ...
                switch (r) {
                    case 'referenceHidden': {
                        let i = await on(e, { ...o, elementContext: 'reference' }),
                            s = Lf(i, n.reference);
                        return { data: { referenceHiddenOffsets: s, referenceHidden: Bf(s) } };
                    }
                    case 'escaped': {
                    ...
                    function p() {
                        ...
                        if (u.length >= 2) {
                            ...
                            let g = Ne(n) === 'left',
                                ...
                                w = $e(...u.map((A) => A.left)),
                                b = u.filter((A) => (g ? A.left === w : A.right === y)),
                                C = b[0].top,
        ...
        return (
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    ...
                    return { ...m, data: { x: m.x - n, y: m.y - r, enabled: { [f]: i, [u]: s } } };
                },
            }
        );
    };
        ...
        t === void 0 && (t = {}),
        {
            ...
            async fn(e) {
                ...
                let w = m - d.top - d.bottom,
                    ...
                    O = x;
                if (
                    ((n = e.middlewareData.shift) != null && n.enabled.x && (O = b),
                    (r = e.middlewareData.shift) != null && r.enabled.y && (k = w),
                    S && !f)
                ) {
                    let A = pe(d.left, 0),
                        $ = pe(d.right, 0),
                        ...
                        K = pe(d.bottom, 0);
                    h
                        ? (O = p - 2 * (A !== 0 || $ !== 0 ? A + $ : pe(d.left, d.right)))
                        : (k = m - 2 * (z !== 0 || K !== 0 ? z + K : pe(d.top, d.bottom)));
                }
...
function lt(t) {
    var e;
    return (e = (Jf(t) ? t.ownerDocument : t.document) || window.document) == null
        ? void 0
        : e.documentElement;
}
function Jf(t) {
...
function qe(t) {
    return fi() ? t instanceof HTMLElement || t instanceof Ae(t).HTMLElement : !1;
}
function qf(t) {
...
function Yf(t) {
    let e = vt(t);
    return ln(e) ? (t.ownerDocument ? t.ownerDocument.body : t.body) : qe(e) && Rn(e) ? e : Yf(e);
}
function ui(t, e, n) {
    var r;
    ...
    if (i) {
        let l = mi(s);
        return e.concat(s, s.visualViewport || [], Rn(o) ? o : [], l && n ? ui(l) : []);
    }
...
function vw(t) {
    ...
    let a = { scrollLeft: 0, scrollTop: 0 },
        ...
        d = Ue(0),
        u = qe(r);
    if ((u || (!u && !i)) && ((sn(r) !== 'body' || Rn(s)) && (a = Mr(r)), qe(r))) {
        let h = Tr(r);
...
function Tw(t) {
    let e = lt(t),
        ...
        l = -n.scrollTop;
    return (
        _e(r).direction === 'rtl' && (s += pe(e.clientWidth, r.clientWidth) - o),
...
function ih(t, e) {
    let n = vt(t);
    return n === e || !Ve(n) || ln(n) ? !1 : _e(n).position === 'fixed' || ih(n, e);
}
function Ow(t, e) {
    let n = e.get(t);
    if (n) return n;
    ...
    for (; Ve(s) && !ln(s); ) {
        ...
        (!a && l.position === 'fixed' && (o = null),
            (
                i
                    ? !a && !o
                    : (!a && l.position === 'static' && !!o && Ew.has(o.position)) ||
                      (Rn(s) && !a && ih(t, s))
            )
                ? (r = r.filter((d) => d !== s))
                : (o = l),
...
function Rw(t) {
    let { element: e, boundary: n, rootBoundary: r, strategy: o } = t,
        s = [...(n === 'clippingAncestors' ? (vr(e) ? [] : Ow(e, this._c)) : [].concat(n)), r],
        l = s[0],
        a = s.reduce(
            (c, d) => {
                let u = Zf(e, d, o);
...
var hh = (t, e) => {
        Ln(
            ...
            e,
            { placement: 'bottom-start', strategy: 'absolute', middleware: [In(), Pn()] }
        ...
        return {
            ...
            render: () => {
                ...
                return {
                    ...
                    onUpdate: (b) => {
                        ((c = b), (a = 0), f(), m(), b.clientRect && hh(b.editor, l));
                    },
                    onKeyDown: (b) =>
                        b.event.key === 'Escape'
...
var zw = function ({ editor: t, overrideSuggestionOptions: e, extensionName: n }) {
        let r = new H(),
            o = e?.char ?? '@',
            i = e?.extraAttributes ?? {};
        return {
    ...
    mh = F.create({
        ...
        addProseMirrorPlugins() {
            ...
            return [
                ...this.storage.suggestions.map(si),
                new P({ view: (e) => (setTimeout(() => t(e), 0), { update: (n) => t(n) }) }),
            ];
        },
        onBeforeCreate() {
            let t = (n) =>
        ...
        for (let p = 0; ; p++) {
            ...
            for (let b = 0; b < y; b++) {
                ...
                for (let x = 0; x < g; x++) {
                    r[C + x] == 0
                        ? (r[C + x] = d)
                        : (i || (i = [])).push({ type: 'collision', row: c, pos: d, n: g - x });
                    let S = w && w[x];
                    if (S) {
                        let k = ((C + x) % e) * 2,
                            O = s[k];
...
function Kw(t, e, n) {
    ...
    for (let o = 0; o < t.map.length; o++) {
        ...
        for (let c = 0; c < a.colspan; c++) {
            ...
            d != null && (!a.colwidth || a.colwidth[c] != d) && ((l || (l = qw(a)))[c] = d);
        }
...
function nx(t, e, n) {
    ...
    if (r instanceof L && (s = r.node.type.spec.tableRole)) {
        ...
        r instanceof D && ex(r)
            ? (i = D.create(o, r.from))
            : r instanceof D && tx(r) && (i = D.create(o, r.$from.start(), r.$from.end()));
...
function na(t, e) {
    ...
    return (e ? e.doc != t.doc && Ph(e.doc, t.doc, 0, r) : t.doc.descendants(r), n);
}
function ox(t, e, n, r) {
    let o = oe.get(e);
...
function Lh(t, { map: e, tableStart: n, table: r }, o) {
    ...
    for (let s = 0; s < e.height; s++) {
        ...
        if (o > 0 && o < e.width && e.map[l - 1] == e.map[l]) {
            let a = e.map[l],
                c = r.nodeAt(a);
            (t.setNodeMarkup(t.mapping.map(n + a), null, Dh(c.attrs, o - e.colCount(a))),
                (s += c.attrs.rowspan - 1));
        } else {
            let a = i == null ? xe(r.type.schema).cell : r.nodeAt(e.map[l + i]).type,
...
function ix(t, { map: e, table: n, tableStart: r }, o) {
    ...
    for (let s = 0; s < e.height; ) {
        ...
        if ((o > 0 && e.map[l - 1] == a) || (o < e.width - 1 && e.map[l + 1] == a))
            t.setNodeMarkup(t.mapping.slice(i).map(r + a), null, cn(d, o - e.colCount(a)));
        else {
    ...
    if (e) {
        ...
        if (
            (i.setNodeMarkup(a + r.tableStart, null, {
                ...Dh(c.attrs, c.attrs.colspan, r.right - r.left - c.attrs.colspan),
    ...
    return (e, n) => {
        ...
        if (n) {
            ...
            (u.setNodeMarkup(i, t({ node: o, row: d.top, col: d.left }), a[0]),
                r instanceof X &&
                    u.setSelection(
                        new X(u.doc.resolve(r.$anchorCell.pos), f ? u.doc.resolve(f) : void 0)
                    ),
                n(u));
        }
        return !0;
...
function fx(t) {
    ...
    if (i == 'row')
        for (let a = 0; a < e.childCount; a++) {
            ...
            ((d || u) && (c = Zl(xe(s).row, new E(c, d, u)).content), l.push(c));
        }
...
function bx(t, e, n) {
    ...
    let r = fx(n),
        o = t.state.selection;
    if (o instanceof X) {
        r || (r = { width: 1, height: 1, rows: [v.from(Zl(xe(t.state.schema).cell, n))] });
        let i = o.$anchorCell.node(-1),
            s = o.$anchorCell.start(-1),
            l = oe.get(i).rectBetween(o.$anchorCell.pos - s, o.$headCell.pos - s);
        return (
        ...
        let i = Si(t.state),
            s = i.start(-1);
        return (Th(t.state, t.dispatch, s, oe.get(i.node(-1)).findCell(i.pos - s), r), !0);
    } else return !1;
}
function wx(t, e) {
    var n;
    ...
    function s() {
        (t.root.removeEventListener('mouseup', s),
            ...
            zt.getState(t.state) != null && t.dispatch(t.state.tr.setMeta(zt, -1)));
    }
    function l(a) {
        let c = a,
...
var xx = class {
    ...
    update(t) {
        return t.type != this.node.type
            ? !1
            : ((this.node = t), ea(t, this.colgroup, this.table, this.defaultCellMinWidth), !0);
    }
    ignoreMutation(t) {
        return (
    ...
    let i = new P({
        ...
        state: {
            init(s, l) {
                ...
                return (r && c && (c[d] = (u, f) => new r(u, n, f)), new kx(-1, !1));
            },
            apply(s, l) {
                return l.apply(s);
            },
...
var kx = class ki {
    ...
    apply(e) {
        ...
        if (r && r.setDragging !== void 0) return new ki(n.activeHandle, r.setDragging);
...
function vx(t, e, n, r) {
    ...
    t.dispatch(t.state.tr.setMeta(Oe, { setDragging: { startX: e.clientX, startWidth: a } }));
    function c(u) {
...
var Ix = class {
    ...
    update(t) {
        return t.type !== this.node.type
            ? !1
            : ((this.node = t), Xh(t, this.colgroup, this.table, this.cellMinWidth), !0);
    }
    ignoreMutation(t) {
        let e = t.target,
...
var Vx = Fx,
    _x = F.create({
        ...
        renderHTML({ node: t, HTMLAttributes: e }) {
            let { colgroup: n, tableWidth: r, tableMinWidth: o } = Px(t, this.options.cellMinWidth),
                i = e.style;
            function s() {
        ...
        addProseMirrorPlugins() {
            return [
                ...(this.options.resizable && this.editor.isEditable
                    ...
                    : []),
                Gh({ allowTableNodeSelection: this.options.allowTableNodeSelection }),
            ];
        },
        extendNodeSchema(t) {
    ...
    Qh = U.create({
        ...
        addExtensions() {
            let t = [];
            return (
                this.options.table !== !1 && t.push(_x.configure(this.options.table)),
                this.options.tableCell !== !1 && t.push(Ox.configure(this.options.tableCell)),
                this.options.tableHeader !== !1 && t.push(Rx.configure(this.options.tableHeader)),
                this.options.tableRow !== !1 && t.push(Dx.configure(this.options.tableRow)),
                t
            );
        },
    });
...
var op = async ({
    ...
    let k = [
            ...
            ...(Object.keys(y).length
                ? [
                      Ef.configure({
                          deleteTriggerWithBackspace: !0,
                          suggestion: rp({ mergeTags: y, noMergeTagSearchResultsMessage: w }),
                          mergeTags: y,
                      }),
                  ]
                : []),
    ...
    for (let T of O) {
        ...
        (T.name === 'placeholder' && T.parent === null && (T = Jl.configure(T.options)),
            A !== -1 ? (k[A] = T) : k.push(T));
    }
    return k;
};
...
var qx = class {
        constructor({
            ...
            ((this.preventHide = !1),
                ...
                (this.shouldShow = ({ view: d, state: u, from: f, to: h }) => {
                    ...
                    return !(!(d.hasFocus() || w) || g || y || !this.editor.isEditable);
                }),
        ...
        get middlewares() {
            ...
            return (
                ...
                this.floatingUIOptions.arrow && t.push(uh(this.floatingUIOptions.arrow)),
        ...
        get virtualElement() {
            ...
            let { selection: e } = this.editor.state,
                n = (t = this.getReferencedVirtualElement) == null ? void 0 : t.call(this);
            if (n) return n;
            let r = tu(this.view, e.from, e.to),
                o = { getBoundingClientRect: () => r, getClientRects: () => [r] };
            if (e instanceof L) {
                let i = this.view.nodeDOM(e.from),
                    s = i.dataset.nodeViewWrapper ? i : i.querySelector('[data-node-view-wrapper]');
                (s && (i = s),
                    i &&
                        (o = {
...
function Jx({
    ...
    return {
        ...
        async init() {
                ...
                z.registerPlugin(
                    la({
                        ...
                        shouldShow: ({ editor: je }) =>
                            q === 'paragraph'
                                ? je.isFocused && je.isActive(q) && !je.state.selection.empty
                                : N && !je.state.selection.empty && je.isActive('paragraph')
                                  ? !1
            ...
            let W = (q) => {
                q.detail.livewireId === m && q.detail.key === f && this.runEditorCommands(q.detail);
            };
            ...
            (window.addEventListener('rich-editor-file-validation-message', Ge),
                ...
                window.dispatchEvent(new CustomEvent(`schema-component-${m}-${f}-loaded`)));
        },
        getEditor() {
            return z;
        },
        ...
        setEditorSelection(N) {
            N &&
                ...
                z
                    ...
                    .command(
                        ({ tr: _ }) => (
                            _.setSelection(I.fromJSON(z.state.doc, this.editorSelection)),
                            !0
                        )
                    )
                    .run());
        ...
        runEditorCommands({ commands: N, editorSelection: _ }) {
            ...
            let W = z.chain();
            (N.forEach((Q) => (W = W[Q.name](...(Q.arguments ?? [])))), W.run());
        },
        togglePanel(N = null) {
        ...
        isPanelActive(N = null) {
            return N === null ? this.activePanel !== null : this.activePanel === N;
        },
        insertMergeTag(N) {
            z.chain()
                .focus()
